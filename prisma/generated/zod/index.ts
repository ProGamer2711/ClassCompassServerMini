...
export const TeacherScalarFieldEnumSchema = z.enum(['id','name','schoolId','subjectIds','createdAt','updatedAt']);

export const StudentScalarFieldEnumSchema = z.enum(['id','name','classId','createdAt','updatedAt']);

export const SubjectScalarFieldEnumSchema = z.enum(['id','name','schoolId','teacherIds','createdAt','updatedAt']);

export const LessonScalarFieldEnumSchema = z.enum(['id','lessonNumber','startTime','endTime','lessonWeeks','roomId','teacherId','subjectId','scheduleId','createdAt','updatedAt']);

export const ScheduleScalarFieldEnumSchema = z.enum(['id','day','classId','createdAt','updatedAt']);
...
export const DaySchema = z.enum(['MONDAY','TUESDAY','WEDNESDAY','THURSDAY','FRIDAY','SATURDAY','SUNDAY']);
...
export const LessonSchema = z.object({
  ...
  id: z.string(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
...
export const TeacherSelectSchema: z.ZodType<Prisma.TeacherSelect> = z.object({
  ...
  lessons: z.union([z.boolean(),z.lazy(() => LessonArgsSchema)]).optional(),
...
export const StudentSelectSchema: z.ZodType<Prisma.StudentSelect> = z.object({
  ...
  createdAt: z.boolean().optional(),
  updatedAt: z.boolean().optional(),
  class: z.union([z.boolean(),z.lazy(() => SchoolClassArgsSchema)]).optional(),
}).strict()
...
export const SchoolClassIncludeSchema: z.ZodType<Prisma.SchoolClassInclude> = z.object({
}).strict()

export const SchoolClassArgsSchema: z.ZodType<Prisma.SchoolClassDefaultArgs> = z.object({
  select: z.lazy(() => SchoolClassSelectSchema).optional(),
  include: z.lazy(() => SchoolClassIncludeSchema).optional(),
}).strict();

export const SchoolClassCountOutputTypeArgsSchema: z.ZodType<Prisma.SchoolClassCountOutputTypeDefaultArgs> = z.object({
  select: z.lazy(() => SchoolClassCountOutputTypeSelectSchema).nullish(),
}).strict();

export const SchoolClassCountOutputTypeSelectSchema: z.ZodType<Prisma.SchoolClassCountOutputTypeSelect> = z.object({
  students: z.boolean().optional(),
  weeklySchedule: z.boolean().optional(),
}).strict();

export const SchoolClassSelectSchema: z.ZodType<Prisma.SchoolClassSelect> = z.object({
  id: z.boolean().optional(),
  name: z.boolean().optional(),
  schoolId: z.boolean().optional(),
  createdAt: z.boolean().optional(),
  ...
  weeklySchedule: z.union([z.boolean(),z.lazy(() => ScheduleArgsSchema)]).optional(),
  _count: z.union([z.boolean(),z.lazy(() => SchoolClassCountOutputTypeArgsSchema)]).optional(),
}).strict()
...
export const SchoolSelectSchema: z.ZodType<Prisma.SchoolSelect> = z.object({
  ...
  subjects: z.union([z.boolean(),z.lazy(() => SubjectArgsSchema)]).optional(),
  teachers: z.union([z.boolean(),z.lazy(() => TeacherArgsSchema)]).optional(),
  buildings: z.union([z.boolean(),z.lazy(() => BuildingArgsSchema)]).optional(),
...
export const BuildingSelectSchema: z.ZodType<Prisma.BuildingSelect> = z.object({
  ...
  updatedAt: z.boolean().optional(),
  school: z.union([z.boolean(),z.lazy(() => SchoolArgsSchema)]).optional(),
  floors: z.union([z.boolean(),z.lazy(() => FloorArgsSchema)]).optional(),
...
.and(z.object({
  ...
  OR: z.lazy(() => TeacherWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => TeacherWhereInputSchema),z.lazy(() => TeacherWhereInputSchema).array() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }) ]).optional(),
  schoolId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  subjectIds: z.lazy(() => StringNullableListFilterSchema).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
...
export const StudentOrderByWithRelationInputSchema: z.ZodType<Prisma.StudentOrderByWithRelationInput> = z.object({
  ...
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional(),
  class: z.lazy(() => SchoolClassOrderByWithRelationInputSchema).optional()
}).strict();
...
export const LessonWhereInputSchema: z.ZodType<Prisma.LessonWhereInput> = z.object({
  ...
  id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  lessonNumber: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  ...
  lessonWeeks: z.union([ z.lazy(() => EnumLessonWeekFilterSchema),z.lazy(() => LessonWeekSchema) ]).optional(),
...
export const LessonWhereUniqueInputSchema: z.ZodType<Prisma.LessonWhereUniqueInput> = z.union([
  z.object({
    id: z.string(),
    lessonNumber_lessonWeeks_scheduleId: z.lazy(() => LessonLessonNumberLessonWeeksScheduleIdCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string(),
  }),
...
.and(z.object({
  id: z.string().optional(),
  lessonNumber_lessonWeeks_scheduleId: z.lazy(() => LessonLessonNumberLessonWeeksScheduleIdCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => LessonWhereInputSchema),z.lazy(() => LessonWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LessonWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LessonWhereInputSchema),z.lazy(() => LessonWhereInputSchema).array() ]).optional(),
  lessonNumber: z.union([ z.lazy(() => IntFilterSchema),z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }) ]).optional(),
  startTime: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  endTime: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => EnumLessonWeekFilterSchema),z.lazy(() => LessonWeekSchema) ]).optional(),
  roomId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
...
export const LessonScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LessonScalarWhereWithAggregatesInput> = z.object({
  ...
  id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  lessonNumber: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  ...
  lessonWeeks: z.union([ z.lazy(() => EnumLessonWeekWithAggregatesFilterSchema),z.lazy(() => LessonWeekSchema) ]).optional(),
...
export const ScheduleWhereUniqueInputSchema: z.ZodType<Prisma.ScheduleWhereUniqueInput> = z.union([
  z.object({
    id: z.string(),
    day_classId: z.lazy(() => ScheduleDayClassIdCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string(),
  }),
...
.and(z.object({
  id: z.string().optional(),
  day_classId: z.lazy(() => ScheduleDayClassIdCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => ScheduleWhereInputSchema),z.lazy(() => ScheduleWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ScheduleWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ScheduleWhereInputSchema),z.lazy(() => ScheduleWhereInputSchema).array() ]).optional(),
  day: z.union([ z.lazy(() => EnumDayFilterSchema),z.lazy(() => DaySchema) ]).optional(),
...
export const SchoolClassWhereInputSchema: z.ZodType<Prisma.SchoolClassWhereInput> = z.object({
  AND: z.union([ z.lazy(() => SchoolClassWhereInputSchema),z.lazy(() => SchoolClassWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => SchoolClassWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => SchoolClassWhereInputSchema),z.lazy(() => SchoolClassWhereInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  schoolId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
...
export const SchoolClassOrderByWithRelationInputSchema: z.ZodType<Prisma.SchoolClassOrderByWithRelationInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  schoolId: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  ...
  weeklySchedule: z.lazy(() => ScheduleOrderByRelationAggregateInputSchema).optional()
}).strict();

export const SchoolClassWhereUniqueInputSchema: z.ZodType<Prisma.SchoolClassWhereUniqueInput> = z.union([
  z.object({
    id: z.string(),
    schoolId_name: z.lazy(() => SchoolClassSchoolIdNameCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string(),
  }),
...
.and(z.object({
  id: z.string().optional(),
  schoolId_name: z.lazy(() => SchoolClassSchoolIdNameCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => SchoolClassWhereInputSchema),z.lazy(() => SchoolClassWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => SchoolClassWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => SchoolClassWhereInputSchema),z.lazy(() => SchoolClassWhereInputSchema).array() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }) ]).optional(),
...
export const SchoolClassOrderByWithAggregationInputSchema: z.ZodType<Prisma.SchoolClassOrderByWithAggregationInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  schoolId: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional(),
  _count: z.lazy(() => SchoolClassCountOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => SchoolClassMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => SchoolClassMinOrderByAggregateInputSchema).optional()
}).strict();

export const SchoolClassScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.SchoolClassScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => SchoolClassScalarWhereWithAggregatesInputSchema),z.lazy(() => SchoolClassScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => SchoolClassScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => SchoolClassScalarWhereWithAggregatesInputSchema),z.lazy(() => SchoolClassScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  schoolId: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
...
export const SchoolWhereInputSchema: z.ZodType<Prisma.SchoolWhereInput> = z.object({
...
export const SchoolWhereUniqueInputSchema: z.ZodType<Prisma.SchoolWhereUniqueInput> = z.union([
  z.object({
    id: z.string(),
    name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" })
  }),
...
.and(z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }).optional(),
  AND: z.union([ z.lazy(() => SchoolWhereInputSchema),z.lazy(() => SchoolWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => SchoolWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => SchoolWhereInputSchema),z.lazy(() => SchoolWhereInputSchema).array() ]).optional(),
  classes: z.lazy(() => SchoolClassListRelationFilterSchema).optional(),
...
export const SchoolScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.SchoolScalarWhereWithAggregatesInput> = z.object({
...
export const BuildingWhereUniqueInputSchema: z.ZodType<Prisma.BuildingWhereUniqueInput> = z.union([
  z.object({
    id: z.string(),
    schoolId_name: z.lazy(() => BuildingSchoolIdNameCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string(),
  }),
...
.and(z.object({
  id: z.string().optional(),
  schoolId_name: z.lazy(() => BuildingSchoolIdNameCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => BuildingWhereInputSchema),z.lazy(() => BuildingWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => BuildingWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => BuildingWhereInputSchema),z.lazy(() => BuildingWhereInputSchema).array() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }) ]).optional(),
...
export const RoomWhereUniqueInputSchema: z.ZodType<Prisma.RoomWhereUniqueInput> = z.union([
  z.object({
    id: z.string(),
    floorId_name: z.lazy(() => RoomFloorIdNameCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string(),
  }),
...
.and(z.object({
  id: z.string().optional(),
  floorId_name: z.lazy(() => RoomFloorIdNameCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => RoomWhereInputSchema),z.lazy(() => RoomWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => RoomWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => RoomWhereInputSchema),z.lazy(() => RoomWhereInputSchema).array() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }) ]).optional(),
...
export const RoomScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.RoomScalarWhereWithAggregatesInput> = z.object({
  ...
  id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  floorId: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
}).strict();
...
export const TeacherCreateInputSchema: z.ZodType<Prisma.TeacherCreateInput> = z.object({
  ...
  lessons: z.lazy(() => LessonCreateNestedManyWithoutTeacherInputSchema).optional(),
...
export const TeacherUncheckedCreateInputSchema: z.ZodType<Prisma.TeacherUncheckedCreateInput> = z.object({
  ...
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  schoolId: z.string(),
  subjectIds: z.union([ z.lazy(() => TeacherCreatesubjectIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  lessons: z.lazy(() => LessonUncheckedCreateNestedManyWithoutTeacherInputSchema).optional(),
...
export const TeacherUpdateInputSchema: z.ZodType<Prisma.TeacherUpdateInput> = z.object({
  ...
  school: z.lazy(() => SchoolUpdateOneRequiredWithoutTeachersNestedInputSchema).optional(),
  lessons: z.lazy(() => LessonUpdateManyWithoutTeacherNestedInputSchema).optional(),
...
export const TeacherUncheckedUpdateInputSchema: z.ZodType<Prisma.TeacherUncheckedUpdateInput> = z.object({
  ...
  subjectIds: z.union([ z.lazy(() => TeacherUpdatesubjectIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessons: z.lazy(() => LessonUncheckedUpdateManyWithoutTeacherNestedInputSchema).optional(),
...
export const StudentCreateInputSchema: z.ZodType<Prisma.StudentCreateInput> = z.object({
  ...
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  class: z.lazy(() => SchoolClassCreateNestedOneWithoutStudentsInputSchema)
}).strict();
...
export const StudentUpdateInputSchema: z.ZodType<Prisma.StudentUpdateInput> = z.object({
  ...
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  class: z.lazy(() => SchoolClassUpdateOneRequiredWithoutStudentsNestedInputSchema).optional()
}).strict();
...
export const SubjectCreateInputSchema: z.ZodType<Prisma.SubjectCreateInput> = z.object({
  ...
  lessons: z.lazy(() => LessonCreateNestedManyWithoutSubjectInputSchema).optional(),
...
export const SubjectUncheckedCreateInputSchema: z.ZodType<Prisma.SubjectUncheckedCreateInput> = z.object({
  ...
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  schoolId: z.string(),
  teacherIds: z.union([ z.lazy(() => SubjectCreateteacherIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  lessons: z.lazy(() => LessonUncheckedCreateNestedManyWithoutSubjectInputSchema).optional(),
...
export const SubjectUpdateInputSchema: z.ZodType<Prisma.SubjectUpdateInput> = z.object({
  ...
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  school: z.lazy(() => SchoolUpdateOneRequiredWithoutSubjectsNestedInputSchema).optional(),
  lessons: z.lazy(() => LessonUpdateManyWithoutSubjectNestedInputSchema).optional(),
...
export const SubjectUncheckedUpdateInputSchema: z.ZodType<Prisma.SubjectUncheckedUpdateInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  schoolId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  teacherIds: z.union([ z.lazy(() => SubjectUpdateteacherIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessons: z.lazy(() => LessonUncheckedUpdateManyWithoutSubjectNestedInputSchema).optional(),
...
export const LessonCreateInputSchema: z.ZodType<Prisma.LessonCreateInput> = z.object({
  ...
  schedule: z.lazy(() => ScheduleCreateNestedOneWithoutLessonsInputSchema)
}).strict();
...
export const LessonUpdateInputSchema: z.ZodType<Prisma.LessonUpdateInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  room: z.lazy(() => RoomUpdateOneRequiredWithoutLessonsNestedInputSchema).optional(),
  teacher: z.lazy(() => TeacherUpdateOneRequiredWithoutLessonsNestedInputSchema).optional(),
  subject: z.lazy(() => SubjectUpdateOneRequiredWithoutLessonsNestedInputSchema).optional(),
  schedule: z.lazy(() => ScheduleUpdateOneRequiredWithoutLessonsNestedInputSchema).optional()
}).strict();
...
export const ScheduleCreateInputSchema: z.ZodType<Prisma.ScheduleCreateInput> = z.object({
  ...
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  class: z.lazy(() => SchoolClassCreateNestedOneWithoutWeeklyScheduleInputSchema),
  lessons: z.lazy(() => LessonCreateNestedManyWithoutScheduleInputSchema).optional()
}).strict();
...
export const ScheduleUncheckedCreateInputSchema: z.ZodType<Prisma.ScheduleUncheckedCreateInput> = z.object({
  ...
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  lessons: z.lazy(() => LessonUncheckedCreateNestedManyWithoutScheduleInputSchema).optional()
}).strict();
...
export const ScheduleUpdateInputSchema: z.ZodType<Prisma.ScheduleUpdateInput> = z.object({
  ...
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  class: z.lazy(() => SchoolClassUpdateOneRequiredWithoutWeeklyScheduleNestedInputSchema).optional(),
  lessons: z.lazy(() => LessonUpdateManyWithoutScheduleNestedInputSchema).optional()
}).strict();
...
export const ScheduleUncheckedUpdateInputSchema: z.ZodType<Prisma.ScheduleUncheckedUpdateInput> = z.object({
  ...
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessons: z.lazy(() => LessonUncheckedUpdateManyWithoutScheduleNestedInputSchema).optional()
}).strict();
...
export const SchoolClassCreateInputSchema: z.ZodType<Prisma.SchoolClassCreateInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  school: z.lazy(() => SchoolCreateNestedOneWithoutClassesInputSchema),
  students: z.lazy(() => StudentCreateNestedManyWithoutClassInputSchema).optional(),
  weeklySchedule: z.lazy(() => ScheduleCreateNestedManyWithoutClassInputSchema).optional()
}).strict();

export const SchoolClassUncheckedCreateInputSchema: z.ZodType<Prisma.SchoolClassUncheckedCreateInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  schoolId: z.string(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  students: z.lazy(() => StudentUncheckedCreateNestedManyWithoutClassInputSchema).optional(),
  weeklySchedule: z.lazy(() => ScheduleUncheckedCreateNestedManyWithoutClassInputSchema).optional()
}).strict();

export const SchoolClassUpdateInputSchema: z.ZodType<Prisma.SchoolClassUpdateInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  school: z.lazy(() => SchoolUpdateOneRequiredWithoutClassesNestedInputSchema).optional(),
  students: z.lazy(() => StudentUpdateManyWithoutClassNestedInputSchema).optional(),
  weeklySchedule: z.lazy(() => ScheduleUpdateManyWithoutClassNestedInputSchema).optional()
}).strict();

export const SchoolClassUncheckedUpdateInputSchema: z.ZodType<Prisma.SchoolClassUncheckedUpdateInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  schoolId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  students: z.lazy(() => StudentUncheckedUpdateManyWithoutClassNestedInputSchema).optional(),
  weeklySchedule: z.lazy(() => ScheduleUncheckedUpdateManyWithoutClassNestedInputSchema).optional()
}).strict();

export const SchoolClassCreateManyInputSchema: z.ZodType<Prisma.SchoolClassCreateManyInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  schoolId: z.string(),
  createdAt: z.coerce.date().optional(),
...
export const SchoolClassUpdateManyMutationInputSchema: z.ZodType<Prisma.SchoolClassUpdateManyMutationInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();

export const SchoolClassUncheckedUpdateManyInputSchema: z.ZodType<Prisma.SchoolClassUncheckedUpdateManyInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  schoolId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const BuildingCreateInputSchema: z.ZodType<Prisma.BuildingCreateInput> = z.object({
  ...
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  school: z.lazy(() => SchoolCreateNestedOneWithoutBuildingsInputSchema),
...
export const BuildingUpdateInputSchema: z.ZodType<Prisma.BuildingUpdateInput> = z.object({
  ...
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  school: z.lazy(() => SchoolUpdateOneRequiredWithoutBuildingsNestedInputSchema).optional(),
...
export const RoomCreateInputSchema: z.ZodType<Prisma.RoomCreateInput> = z.object({
  ...
  lessons: z.lazy(() => LessonCreateNestedManyWithoutRoomInputSchema).optional()
}).strict();
...
export const RoomUncheckedCreateInputSchema: z.ZodType<Prisma.RoomUncheckedCreateInput> = z.object({
  ...
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  lessons: z.lazy(() => LessonUncheckedCreateNestedManyWithoutRoomInputSchema).optional()
}).strict();
...
export const RoomUpdateInputSchema: z.ZodType<Prisma.RoomUpdateInput> = z.object({
  ...
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  floor: z.lazy(() => FloorUpdateOneRequiredWithoutRoomsNestedInputSchema).optional(),
  lessons: z.lazy(() => LessonUpdateManyWithoutRoomNestedInputSchema).optional()
}).strict();

export const RoomUncheckedUpdateInputSchema: z.ZodType<Prisma.RoomUncheckedUpdateInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  floorId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessons: z.lazy(() => LessonUncheckedUpdateManyWithoutRoomNestedInputSchema).optional()
}).strict();
...
export const EnumLessonWeekFilterSchema: z.ZodType<Prisma.EnumLessonWeekFilter> = z.object({
  equals: z.lazy(() => LessonWeekSchema).optional(),
  in: z.lazy(() => LessonWeekSchema).array().optional(),
  notIn: z.lazy(() => LessonWeekSchema).array().optional(),
...
export const LessonLessonNumberLessonWeeksScheduleIdCompoundUniqueInputSchema: z.ZodType<Prisma.LessonLessonNumberLessonWeeksScheduleIdCompoundUniqueInput> = z.object({
...
export const EnumLessonWeekWithAggregatesFilterSchema: z.ZodType<Prisma.EnumLessonWeekWithAggregatesFilter> = z.object({
  equals: z.lazy(() => LessonWeekSchema).optional(),
  in: z.lazy(() => LessonWeekSchema).array().optional(),
  notIn: z.lazy(() => LessonWeekSchema).array().optional(),
  not: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => NestedEnumLessonWeekWithAggregatesFilterSchema) ]).optional(),
  _count: z.lazy(() => NestedIntFilterSchema).optional(),
...
export const ScheduleDayClassIdCompoundUniqueInputSchema: z.ZodType<Prisma.ScheduleDayClassIdCompoundUniqueInput> = z.object({
  day: z.lazy(() => DaySchema),
  classId: z.string()
}).strict();
...
export const SchoolClassSchoolIdNameCompoundUniqueInputSchema: z.ZodType<Prisma.SchoolClassSchoolIdNameCompoundUniqueInput> = z.object({
  schoolId: z.string(),
  name: z.string()
}).strict();

export const SchoolClassCountOrderByAggregateInputSchema: z.ZodType<Prisma.SchoolClassCountOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  schoolId: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
...
export const SchoolClassMaxOrderByAggregateInputSchema: z.ZodType<Prisma.SchoolClassMaxOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  schoolId: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
...
export const SchoolClassMinOrderByAggregateInputSchema: z.ZodType<Prisma.SchoolClassMinOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  schoolId: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
...
export const SchoolClassListRelationFilterSchema: z.ZodType<Prisma.SchoolClassListRelationFilter> = z.object({
...
export const SchoolClassOrderByRelationAggregateInputSchema: z.ZodType<Prisma.SchoolClassOrderByRelationAggregateInput> = z.object({
  _count: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const BuildingSchoolIdNameCompoundUniqueInputSchema: z.ZodType<Prisma.BuildingSchoolIdNameCompoundUniqueInput> = z.object({
  schoolId: z.string(),
  name: z.string()
}).strict();
...
export const FloorBuildingIdNumberCompoundUniqueInputSchema: z.ZodType<Prisma.FloorBuildingIdNumberCompoundUniqueInput> = z.object({
  buildingId: z.string(),
  number: z.number()
}).strict();
...
export const RoomFloorIdNameCompoundUniqueInputSchema: z.ZodType<Prisma.RoomFloorIdNameCompoundUniqueInput> = z.object({
  floorId: z.string(),
  name: z.string()
}).strict();
...
export const SchoolCreateNestedOneWithoutTeachersInputSchema: z.ZodType<Prisma.SchoolCreateNestedOneWithoutTeachersInput> = z.object({
  create: z.union([ z.lazy(() => SchoolCreateWithoutTeachersInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutTeachersInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolCreateOrConnectWithoutTeachersInputSchema).optional(),
  connect: z.lazy(() => SchoolWhereUniqueInputSchema).optional()
}).strict();

export const LessonCreateNestedManyWithoutTeacherInputSchema: z.ZodType<Prisma.LessonCreateNestedManyWithoutTeacherInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutTeacherInputSchema),z.lazy(() => LessonCreateWithoutTeacherInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutTeacherInputSchema),z.lazy(() => LessonUncheckedCreateWithoutTeacherInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutTeacherInputSchema),z.lazy(() => LessonCreateOrConnectWithoutTeacherInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyTeacherInputEnvelopeSchema).optional(),
...
export const TeacherCreatesubjectIdsInputSchema: z.ZodType<Prisma.TeacherCreatesubjectIdsInput> = z.object({
  set: z.string().array()
}).strict();

export const LessonUncheckedCreateNestedManyWithoutTeacherInputSchema: z.ZodType<Prisma.LessonUncheckedCreateNestedManyWithoutTeacherInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutTeacherInputSchema),z.lazy(() => LessonCreateWithoutTeacherInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutTeacherInputSchema),z.lazy(() => LessonUncheckedCreateWithoutTeacherInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutTeacherInputSchema),z.lazy(() => LessonCreateOrConnectWithoutTeacherInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyTeacherInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
...
export const SchoolUpdateOneRequiredWithoutTeachersNestedInputSchema: z.ZodType<Prisma.SchoolUpdateOneRequiredWithoutTeachersNestedInput> = z.object({
  create: z.union([ z.lazy(() => SchoolCreateWithoutTeachersInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutTeachersInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolCreateOrConnectWithoutTeachersInputSchema).optional(),
  upsert: z.lazy(() => SchoolUpsertWithoutTeachersInputSchema).optional(),
  connect: z.lazy(() => SchoolWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => SchoolUpdateToOneWithWhereWithoutTeachersInputSchema),z.lazy(() => SchoolUpdateWithoutTeachersInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutTeachersInputSchema) ]).optional(),
}).strict();

export const LessonUpdateManyWithoutTeacherNestedInputSchema: z.ZodType<Prisma.LessonUpdateManyWithoutTeacherNestedInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutTeacherInputSchema),z.lazy(() => LessonCreateWithoutTeacherInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutTeacherInputSchema),z.lazy(() => LessonUncheckedCreateWithoutTeacherInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutTeacherInputSchema),z.lazy(() => LessonCreateOrConnectWithoutTeacherInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LessonUpsertWithWhereUniqueWithoutTeacherInputSchema),z.lazy(() => LessonUpsertWithWhereUniqueWithoutTeacherInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyTeacherInputEnvelopeSchema).optional(),
  ...
  connect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => LessonUpdateWithWhereUniqueWithoutTeacherInputSchema),z.lazy(() => LessonUpdateWithWhereUniqueWithoutTeacherInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LessonUpdateManyWithWhereWithoutTeacherInputSchema),z.lazy(() => LessonUpdateManyWithWhereWithoutTeacherInputSchema).array() ]).optional(),
...
export const TeacherUpdatesubjectIdsInputSchema: z.ZodType<Prisma.TeacherUpdatesubjectIdsInput> = z.object({
  set: z.string().array().optional(),
  push: z.union([ z.string(),z.string().array() ]).optional(),
}).strict();

export const LessonUncheckedUpdateManyWithoutTeacherNestedInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateManyWithoutTeacherNestedInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutTeacherInputSchema),z.lazy(() => LessonCreateWithoutTeacherInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutTeacherInputSchema),z.lazy(() => LessonUncheckedCreateWithoutTeacherInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutTeacherInputSchema),z.lazy(() => LessonCreateOrConnectWithoutTeacherInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LessonUpsertWithWhereUniqueWithoutTeacherInputSchema),z.lazy(() => LessonUpsertWithWhereUniqueWithoutTeacherInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyTeacherInputEnvelopeSchema).optional(),
...
export const SchoolClassCreateNestedOneWithoutStudentsInputSchema: z.ZodType<Prisma.SchoolClassCreateNestedOneWithoutStudentsInput> = z.object({
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutStudentsInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutStudentsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolClassCreateOrConnectWithoutStudentsInputSchema).optional(),
  connect: z.lazy(() => SchoolClassWhereUniqueInputSchema).optional()
}).strict();

export const SchoolClassUpdateOneRequiredWithoutStudentsNestedInputSchema: z.ZodType<Prisma.SchoolClassUpdateOneRequiredWithoutStudentsNestedInput> = z.object({
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutStudentsInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutStudentsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolClassCreateOrConnectWithoutStudentsInputSchema).optional(),
  upsert: z.lazy(() => SchoolClassUpsertWithoutStudentsInputSchema).optional(),
  connect: z.lazy(() => SchoolClassWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => SchoolClassUpdateToOneWithWhereWithoutStudentsInputSchema),z.lazy(() => SchoolClassUpdateWithoutStudentsInputSchema),z.lazy(() => SchoolClassUncheckedUpdateWithoutStudentsInputSchema) ]).optional(),
}).strict();

export const SchoolCreateNestedOneWithoutSubjectsInputSchema: z.ZodType<Prisma.SchoolCreateNestedOneWithoutSubjectsInput> = z.object({
  create: z.union([ z.lazy(() => SchoolCreateWithoutSubjectsInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutSubjectsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolCreateOrConnectWithoutSubjectsInputSchema).optional(),
  connect: z.lazy(() => SchoolWhereUniqueInputSchema).optional()
}).strict();

export const LessonCreateNestedManyWithoutSubjectInputSchema: z.ZodType<Prisma.LessonCreateNestedManyWithoutSubjectInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutSubjectInputSchema),z.lazy(() => LessonCreateWithoutSubjectInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutSubjectInputSchema),z.lazy(() => LessonUncheckedCreateWithoutSubjectInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutSubjectInputSchema),z.lazy(() => LessonCreateOrConnectWithoutSubjectInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManySubjectInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const SubjectCreateteacherIdsInputSchema: z.ZodType<Prisma.SubjectCreateteacherIdsInput> = z.object({
  set: z.string().array()
}).strict();

export const LessonUncheckedCreateNestedManyWithoutSubjectInputSchema: z.ZodType<Prisma.LessonUncheckedCreateNestedManyWithoutSubjectInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutSubjectInputSchema),z.lazy(() => LessonCreateWithoutSubjectInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutSubjectInputSchema),z.lazy(() => LessonUncheckedCreateWithoutSubjectInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutSubjectInputSchema),z.lazy(() => LessonCreateOrConnectWithoutSubjectInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManySubjectInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
...
export const SchoolUpdateOneRequiredWithoutSubjectsNestedInputSchema: z.ZodType<Prisma.SchoolUpdateOneRequiredWithoutSubjectsNestedInput> = z.object({
  create: z.union([ z.lazy(() => SchoolCreateWithoutSubjectsInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutSubjectsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolCreateOrConnectWithoutSubjectsInputSchema).optional(),
  upsert: z.lazy(() => SchoolUpsertWithoutSubjectsInputSchema).optional(),
  connect: z.lazy(() => SchoolWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => SchoolUpdateToOneWithWhereWithoutSubjectsInputSchema),z.lazy(() => SchoolUpdateWithoutSubjectsInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutSubjectsInputSchema) ]).optional(),
}).strict();

export const LessonUpdateManyWithoutSubjectNestedInputSchema: z.ZodType<Prisma.LessonUpdateManyWithoutSubjectNestedInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutSubjectInputSchema),z.lazy(() => LessonCreateWithoutSubjectInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutSubjectInputSchema),z.lazy(() => LessonUncheckedCreateWithoutSubjectInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutSubjectInputSchema),z.lazy(() => LessonCreateOrConnectWithoutSubjectInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LessonUpsertWithWhereUniqueWithoutSubjectInputSchema),z.lazy(() => LessonUpsertWithWhereUniqueWithoutSubjectInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManySubjectInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => LessonUpdateWithWhereUniqueWithoutSubjectInputSchema),z.lazy(() => LessonUpdateWithWhereUniqueWithoutSubjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LessonUpdateManyWithWhereWithoutSubjectInputSchema),z.lazy(() => LessonUpdateManyWithWhereWithoutSubjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LessonScalarWhereInputSchema),z.lazy(() => LessonScalarWhereInputSchema).array() ]).optional(),
}).strict();
...
export const SubjectUpdateteacherIdsInputSchema: z.ZodType<Prisma.SubjectUpdateteacherIdsInput> = z.object({
  set: z.string().array().optional(),
  push: z.union([ z.string(),z.string().array() ]).optional(),
}).strict();

export const LessonUncheckedUpdateManyWithoutSubjectNestedInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateManyWithoutSubjectNestedInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutSubjectInputSchema),z.lazy(() => LessonCreateWithoutSubjectInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutSubjectInputSchema),z.lazy(() => LessonUncheckedCreateWithoutSubjectInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutSubjectInputSchema),z.lazy(() => LessonCreateOrConnectWithoutSubjectInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LessonUpsertWithWhereUniqueWithoutSubjectInputSchema),z.lazy(() => LessonUpsertWithWhereUniqueWithoutSubjectInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManySubjectInputEnvelopeSchema).optional(),
...
export const RoomCreateNestedOneWithoutLessonsInputSchema: z.ZodType<Prisma.RoomCreateNestedOneWithoutLessonsInput> = z.object({
  create: z.union([ z.lazy(() => RoomCreateWithoutLessonsInputSchema),z.lazy(() => RoomUncheckedCreateWithoutLessonsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => RoomCreateOrConnectWithoutLessonsInputSchema).optional(),
  connect: z.lazy(() => RoomWhereUniqueInputSchema).optional()
}).strict();

export const TeacherCreateNestedOneWithoutLessonsInputSchema: z.ZodType<Prisma.TeacherCreateNestedOneWithoutLessonsInput> = z.object({
  create: z.union([ z.lazy(() => TeacherCreateWithoutLessonsInputSchema),z.lazy(() => TeacherUncheckedCreateWithoutLessonsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => TeacherCreateOrConnectWithoutLessonsInputSchema).optional(),
  connect: z.lazy(() => TeacherWhereUniqueInputSchema).optional()
}).strict();

export const SubjectCreateNestedOneWithoutLessonsInputSchema: z.ZodType<Prisma.SubjectCreateNestedOneWithoutLessonsInput> = z.object({
  create: z.union([ z.lazy(() => SubjectCreateWithoutLessonsInputSchema),z.lazy(() => SubjectUncheckedCreateWithoutLessonsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SubjectCreateOrConnectWithoutLessonsInputSchema).optional(),
  connect: z.lazy(() => SubjectWhereUniqueInputSchema).optional()
}).strict();

export const ScheduleCreateNestedOneWithoutLessonsInputSchema: z.ZodType<Prisma.ScheduleCreateNestedOneWithoutLessonsInput> = z.object({
  create: z.union([ z.lazy(() => ScheduleCreateWithoutLessonsInputSchema),z.lazy(() => ScheduleUncheckedCreateWithoutLessonsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ScheduleCreateOrConnectWithoutLessonsInputSchema).optional(),
...
export const EnumLessonWeekFieldUpdateOperationsInputSchema: z.ZodType<Prisma.EnumLessonWeekFieldUpdateOperationsInput> = z.object({
  set: z.lazy(() => LessonWeekSchema).optional()
}).strict();

export const RoomUpdateOneRequiredWithoutLessonsNestedInputSchema: z.ZodType<Prisma.RoomUpdateOneRequiredWithoutLessonsNestedInput> = z.object({
  create: z.union([ z.lazy(() => RoomCreateWithoutLessonsInputSchema),z.lazy(() => RoomUncheckedCreateWithoutLessonsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => RoomCreateOrConnectWithoutLessonsInputSchema).optional(),
  upsert: z.lazy(() => RoomUpsertWithoutLessonsInputSchema).optional(),
  connect: z.lazy(() => RoomWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => RoomUpdateToOneWithWhereWithoutLessonsInputSchema),z.lazy(() => RoomUpdateWithoutLessonsInputSchema),z.lazy(() => RoomUncheckedUpdateWithoutLessonsInputSchema) ]).optional(),
}).strict();

export const TeacherUpdateOneRequiredWithoutLessonsNestedInputSchema: z.ZodType<Prisma.TeacherUpdateOneRequiredWithoutLessonsNestedInput> = z.object({
  create: z.union([ z.lazy(() => TeacherCreateWithoutLessonsInputSchema),z.lazy(() => TeacherUncheckedCreateWithoutLessonsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => TeacherCreateOrConnectWithoutLessonsInputSchema).optional(),
  upsert: z.lazy(() => TeacherUpsertWithoutLessonsInputSchema).optional(),
  connect: z.lazy(() => TeacherWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => TeacherUpdateToOneWithWhereWithoutLessonsInputSchema),z.lazy(() => TeacherUpdateWithoutLessonsInputSchema),z.lazy(() => TeacherUncheckedUpdateWithoutLessonsInputSchema) ]).optional(),
}).strict();

export const SubjectUpdateOneRequiredWithoutLessonsNestedInputSchema: z.ZodType<Prisma.SubjectUpdateOneRequiredWithoutLessonsNestedInput> = z.object({
  create: z.union([ z.lazy(() => SubjectCreateWithoutLessonsInputSchema),z.lazy(() => SubjectUncheckedCreateWithoutLessonsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SubjectCreateOrConnectWithoutLessonsInputSchema).optional(),
  upsert: z.lazy(() => SubjectUpsertWithoutLessonsInputSchema).optional(),
  connect: z.lazy(() => SubjectWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => SubjectUpdateToOneWithWhereWithoutLessonsInputSchema),z.lazy(() => SubjectUpdateWithoutLessonsInputSchema),z.lazy(() => SubjectUncheckedUpdateWithoutLessonsInputSchema) ]).optional(),
}).strict();

export const ScheduleUpdateOneRequiredWithoutLessonsNestedInputSchema: z.ZodType<Prisma.ScheduleUpdateOneRequiredWithoutLessonsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ScheduleCreateWithoutLessonsInputSchema),z.lazy(() => ScheduleUncheckedCreateWithoutLessonsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ScheduleCreateOrConnectWithoutLessonsInputSchema).optional(),
  upsert: z.lazy(() => ScheduleUpsertWithoutLessonsInputSchema).optional(),
  connect: z.lazy(() => ScheduleWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => ScheduleUpdateToOneWithWhereWithoutLessonsInputSchema),z.lazy(() => ScheduleUpdateWithoutLessonsInputSchema),z.lazy(() => ScheduleUncheckedUpdateWithoutLessonsInputSchema) ]).optional(),
}).strict();

export const SchoolClassCreateNestedOneWithoutWeeklyScheduleInputSchema: z.ZodType<Prisma.SchoolClassCreateNestedOneWithoutWeeklyScheduleInput> = z.object({
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutWeeklyScheduleInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutWeeklyScheduleInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolClassCreateOrConnectWithoutWeeklyScheduleInputSchema).optional(),
  connect: z.lazy(() => SchoolClassWhereUniqueInputSchema).optional()
}).strict();

export const LessonCreateNestedManyWithoutScheduleInputSchema: z.ZodType<Prisma.LessonCreateNestedManyWithoutScheduleInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutScheduleInputSchema),z.lazy(() => LessonCreateWithoutScheduleInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutScheduleInputSchema),z.lazy(() => LessonUncheckedCreateWithoutScheduleInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutScheduleInputSchema),z.lazy(() => LessonCreateOrConnectWithoutScheduleInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyScheduleInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const LessonUncheckedCreateNestedManyWithoutScheduleInputSchema: z.ZodType<Prisma.LessonUncheckedCreateNestedManyWithoutScheduleInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutScheduleInputSchema),z.lazy(() => LessonCreateWithoutScheduleInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutScheduleInputSchema),z.lazy(() => LessonUncheckedCreateWithoutScheduleInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutScheduleInputSchema),z.lazy(() => LessonCreateOrConnectWithoutScheduleInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyScheduleInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
...
export const SchoolClassUpdateOneRequiredWithoutWeeklyScheduleNestedInputSchema: z.ZodType<Prisma.SchoolClassUpdateOneRequiredWithoutWeeklyScheduleNestedInput> = z.object({
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutWeeklyScheduleInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutWeeklyScheduleInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolClassCreateOrConnectWithoutWeeklyScheduleInputSchema).optional(),
  upsert: z.lazy(() => SchoolClassUpsertWithoutWeeklyScheduleInputSchema).optional(),
  connect: z.lazy(() => SchoolClassWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => SchoolClassUpdateToOneWithWhereWithoutWeeklyScheduleInputSchema),z.lazy(() => SchoolClassUpdateWithoutWeeklyScheduleInputSchema),z.lazy(() => SchoolClassUncheckedUpdateWithoutWeeklyScheduleInputSchema) ]).optional(),
}).strict();

export const LessonUpdateManyWithoutScheduleNestedInputSchema: z.ZodType<Prisma.LessonUpdateManyWithoutScheduleNestedInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutScheduleInputSchema),z.lazy(() => LessonCreateWithoutScheduleInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutScheduleInputSchema),z.lazy(() => LessonUncheckedCreateWithoutScheduleInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutScheduleInputSchema),z.lazy(() => LessonCreateOrConnectWithoutScheduleInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LessonUpsertWithWhereUniqueWithoutScheduleInputSchema),z.lazy(() => LessonUpsertWithWhereUniqueWithoutScheduleInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyScheduleInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => LessonUpdateWithWhereUniqueWithoutScheduleInputSchema),z.lazy(() => LessonUpdateWithWhereUniqueWithoutScheduleInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LessonUpdateManyWithWhereWithoutScheduleInputSchema),z.lazy(() => LessonUpdateManyWithWhereWithoutScheduleInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LessonScalarWhereInputSchema),z.lazy(() => LessonScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const LessonUncheckedUpdateManyWithoutScheduleNestedInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateManyWithoutScheduleNestedInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutScheduleInputSchema),z.lazy(() => LessonCreateWithoutScheduleInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutScheduleInputSchema),z.lazy(() => LessonUncheckedCreateWithoutScheduleInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutScheduleInputSchema),z.lazy(() => LessonCreateOrConnectWithoutScheduleInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LessonUpsertWithWhereUniqueWithoutScheduleInputSchema),z.lazy(() => LessonUpsertWithWhereUniqueWithoutScheduleInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyScheduleInputEnvelopeSchema).optional(),
...
export const SchoolCreateNestedOneWithoutClassesInputSchema: z.ZodType<Prisma.SchoolCreateNestedOneWithoutClassesInput> = z.object({
  create: z.union([ z.lazy(() => SchoolCreateWithoutClassesInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutClassesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolCreateOrConnectWithoutClassesInputSchema).optional(),
  connect: z.lazy(() => SchoolWhereUniqueInputSchema).optional()
}).strict();

export const StudentCreateNestedManyWithoutClassInputSchema: z.ZodType<Prisma.StudentCreateNestedManyWithoutClassInput> = z.object({
  create: z.union([ z.lazy(() => StudentCreateWithoutClassInputSchema),z.lazy(() => StudentCreateWithoutClassInputSchema).array(),z.lazy(() => StudentUncheckedCreateWithoutClassInputSchema),z.lazy(() => StudentUncheckedCreateWithoutClassInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => StudentCreateOrConnectWithoutClassInputSchema),z.lazy(() => StudentCreateOrConnectWithoutClassInputSchema).array() ]).optional(),
  createMany: z.lazy(() => StudentCreateManyClassInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => StudentWhereUniqueInputSchema),z.lazy(() => StudentWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const ScheduleCreateNestedManyWithoutClassInputSchema: z.ZodType<Prisma.ScheduleCreateNestedManyWithoutClassInput> = z.object({
  create: z.union([ z.lazy(() => ScheduleCreateWithoutClassInputSchema),z.lazy(() => ScheduleCreateWithoutClassInputSchema).array(),z.lazy(() => ScheduleUncheckedCreateWithoutClassInputSchema),z.lazy(() => ScheduleUncheckedCreateWithoutClassInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ScheduleCreateOrConnectWithoutClassInputSchema),z.lazy(() => ScheduleCreateOrConnectWithoutClassInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ScheduleCreateManyClassInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ScheduleWhereUniqueInputSchema),z.lazy(() => ScheduleWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const StudentUncheckedCreateNestedManyWithoutClassInputSchema: z.ZodType<Prisma.StudentUncheckedCreateNestedManyWithoutClassInput> = z.object({
  create: z.union([ z.lazy(() => StudentCreateWithoutClassInputSchema),z.lazy(() => StudentCreateWithoutClassInputSchema).array(),z.lazy(() => StudentUncheckedCreateWithoutClassInputSchema),z.lazy(() => StudentUncheckedCreateWithoutClassInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => StudentCreateOrConnectWithoutClassInputSchema),z.lazy(() => StudentCreateOrConnectWithoutClassInputSchema).array() ]).optional(),
  createMany: z.lazy(() => StudentCreateManyClassInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => StudentWhereUniqueInputSchema),z.lazy(() => StudentWhereUniqueInputSchema).array() ]).optional(),
...
export const ScheduleUncheckedCreateNestedManyWithoutClassInputSchema: z.ZodType<Prisma.ScheduleUncheckedCreateNestedManyWithoutClassInput> = z.object({
  create: z.union([ z.lazy(() => ScheduleCreateWithoutClassInputSchema),z.lazy(() => ScheduleCreateWithoutClassInputSchema).array(),z.lazy(() => ScheduleUncheckedCreateWithoutClassInputSchema),z.lazy(() => ScheduleUncheckedCreateWithoutClassInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ScheduleCreateOrConnectWithoutClassInputSchema),z.lazy(() => ScheduleCreateOrConnectWithoutClassInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ScheduleCreateManyClassInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ScheduleWhereUniqueInputSchema),z.lazy(() => ScheduleWhereUniqueInputSchema).array() ]).optional(),
...
export const SchoolUpdateOneRequiredWithoutClassesNestedInputSchema: z.ZodType<Prisma.SchoolUpdateOneRequiredWithoutClassesNestedInput> = z.object({
  create: z.union([ z.lazy(() => SchoolCreateWithoutClassesInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutClassesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolCreateOrConnectWithoutClassesInputSchema).optional(),
  upsert: z.lazy(() => SchoolUpsertWithoutClassesInputSchema).optional(),
  connect: z.lazy(() => SchoolWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => SchoolUpdateToOneWithWhereWithoutClassesInputSchema),z.lazy(() => SchoolUpdateWithoutClassesInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutClassesInputSchema) ]).optional(),
}).strict();

export const StudentUpdateManyWithoutClassNestedInputSchema: z.ZodType<Prisma.StudentUpdateManyWithoutClassNestedInput> = z.object({
  create: z.union([ z.lazy(() => StudentCreateWithoutClassInputSchema),z.lazy(() => StudentCreateWithoutClassInputSchema).array(),z.lazy(() => StudentUncheckedCreateWithoutClassInputSchema),z.lazy(() => StudentUncheckedCreateWithoutClassInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => StudentCreateOrConnectWithoutClassInputSchema),z.lazy(() => StudentCreateOrConnectWithoutClassInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => StudentUpsertWithWhereUniqueWithoutClassInputSchema),z.lazy(() => StudentUpsertWithWhereUniqueWithoutClassInputSchema).array() ]).optional(),
  createMany: z.lazy(() => StudentCreateManyClassInputEnvelopeSchema).optional(),
  ...
  connect: z.union([ z.lazy(() => StudentWhereUniqueInputSchema),z.lazy(() => StudentWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => StudentUpdateWithWhereUniqueWithoutClassInputSchema),z.lazy(() => StudentUpdateWithWhereUniqueWithoutClassInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => StudentUpdateManyWithWhereWithoutClassInputSchema),z.lazy(() => StudentUpdateManyWithWhereWithoutClassInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => StudentScalarWhereInputSchema),z.lazy(() => StudentScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const ScheduleUpdateManyWithoutClassNestedInputSchema: z.ZodType<Prisma.ScheduleUpdateManyWithoutClassNestedInput> = z.object({
  create: z.union([ z.lazy(() => ScheduleCreateWithoutClassInputSchema),z.lazy(() => ScheduleCreateWithoutClassInputSchema).array(),z.lazy(() => ScheduleUncheckedCreateWithoutClassInputSchema),z.lazy(() => ScheduleUncheckedCreateWithoutClassInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ScheduleCreateOrConnectWithoutClassInputSchema),z.lazy(() => ScheduleCreateOrConnectWithoutClassInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ScheduleUpsertWithWhereUniqueWithoutClassInputSchema),z.lazy(() => ScheduleUpsertWithWhereUniqueWithoutClassInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ScheduleCreateManyClassInputEnvelopeSchema).optional(),
  ...
  connect: z.union([ z.lazy(() => ScheduleWhereUniqueInputSchema),z.lazy(() => ScheduleWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ScheduleUpdateWithWhereUniqueWithoutClassInputSchema),z.lazy(() => ScheduleUpdateWithWhereUniqueWithoutClassInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ScheduleUpdateManyWithWhereWithoutClassInputSchema),z.lazy(() => ScheduleUpdateManyWithWhereWithoutClassInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ScheduleScalarWhereInputSchema),z.lazy(() => ScheduleScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const StudentUncheckedUpdateManyWithoutClassNestedInputSchema: z.ZodType<Prisma.StudentUncheckedUpdateManyWithoutClassNestedInput> = z.object({
  create: z.union([ z.lazy(() => StudentCreateWithoutClassInputSchema),z.lazy(() => StudentCreateWithoutClassInputSchema).array(),z.lazy(() => StudentUncheckedCreateWithoutClassInputSchema),z.lazy(() => StudentUncheckedCreateWithoutClassInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => StudentCreateOrConnectWithoutClassInputSchema),z.lazy(() => StudentCreateOrConnectWithoutClassInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => StudentUpsertWithWhereUniqueWithoutClassInputSchema),z.lazy(() => StudentUpsertWithWhereUniqueWithoutClassInputSchema).array() ]).optional(),
  createMany: z.lazy(() => StudentCreateManyClassInputEnvelopeSchema).optional(),
...
export const ScheduleUncheckedUpdateManyWithoutClassNestedInputSchema: z.ZodType<Prisma.ScheduleUncheckedUpdateManyWithoutClassNestedInput> = z.object({
  create: z.union([ z.lazy(() => ScheduleCreateWithoutClassInputSchema),z.lazy(() => ScheduleCreateWithoutClassInputSchema).array(),z.lazy(() => ScheduleUncheckedCreateWithoutClassInputSchema),z.lazy(() => ScheduleUncheckedCreateWithoutClassInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ScheduleCreateOrConnectWithoutClassInputSchema),z.lazy(() => ScheduleCreateOrConnectWithoutClassInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ScheduleUpsertWithWhereUniqueWithoutClassInputSchema),z.lazy(() => ScheduleUpsertWithWhereUniqueWithoutClassInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ScheduleCreateManyClassInputEnvelopeSchema).optional(),
...
export const SchoolClassCreateNestedManyWithoutSchoolInputSchema: z.ZodType<Prisma.SchoolClassCreateNestedManyWithoutSchoolInput> = z.object({
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutSchoolInputSchema),z.lazy(() => SchoolClassCreateWithoutSchoolInputSchema).array(),z.lazy(() => SchoolClassUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SchoolClassCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => SchoolClassCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SchoolClassCreateManySchoolInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => SchoolClassWhereUniqueInputSchema),z.lazy(() => SchoolClassWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const SubjectCreateNestedManyWithoutSchoolInputSchema: z.ZodType<Prisma.SubjectCreateNestedManyWithoutSchoolInput> = z.object({
  create: z.union([ z.lazy(() => SubjectCreateWithoutSchoolInputSchema),z.lazy(() => SubjectCreateWithoutSchoolInputSchema).array(),z.lazy(() => SubjectUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => SubjectUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubjectCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => SubjectCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubjectCreateManySchoolInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => SubjectWhereUniqueInputSchema),z.lazy(() => SubjectWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const TeacherCreateNestedManyWithoutSchoolInputSchema: z.ZodType<Prisma.TeacherCreateNestedManyWithoutSchoolInput> = z.object({
  create: z.union([ z.lazy(() => TeacherCreateWithoutSchoolInputSchema),z.lazy(() => TeacherCreateWithoutSchoolInputSchema).array(),z.lazy(() => TeacherUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => TeacherUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => TeacherCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => TeacherCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => TeacherCreateManySchoolInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => TeacherWhereUniqueInputSchema),z.lazy(() => TeacherWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const BuildingCreateNestedManyWithoutSchoolInputSchema: z.ZodType<Prisma.BuildingCreateNestedManyWithoutSchoolInput> = z.object({
  create: z.union([ z.lazy(() => BuildingCreateWithoutSchoolInputSchema),z.lazy(() => BuildingCreateWithoutSchoolInputSchema).array(),z.lazy(() => BuildingUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => BuildingUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => BuildingCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => BuildingCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => BuildingCreateManySchoolInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => BuildingWhereUniqueInputSchema),z.lazy(() => BuildingWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const SchoolClassUncheckedCreateNestedManyWithoutSchoolInputSchema: z.ZodType<Prisma.SchoolClassUncheckedCreateNestedManyWithoutSchoolInput> = z.object({
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutSchoolInputSchema),z.lazy(() => SchoolClassCreateWithoutSchoolInputSchema).array(),z.lazy(() => SchoolClassUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SchoolClassCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => SchoolClassCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SchoolClassCreateManySchoolInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => SchoolClassWhereUniqueInputSchema),z.lazy(() => SchoolClassWhereUniqueInputSchema).array() ]).optional(),
...
export const SubjectUncheckedCreateNestedManyWithoutSchoolInputSchema: z.ZodType<Prisma.SubjectUncheckedCreateNestedManyWithoutSchoolInput> = z.object({
  create: z.union([ z.lazy(() => SubjectCreateWithoutSchoolInputSchema),z.lazy(() => SubjectCreateWithoutSchoolInputSchema).array(),z.lazy(() => SubjectUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => SubjectUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubjectCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => SubjectCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubjectCreateManySchoolInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => SubjectWhereUniqueInputSchema),z.lazy(() => SubjectWhereUniqueInputSchema).array() ]).optional(),
...
export const TeacherUncheckedCreateNestedManyWithoutSchoolInputSchema: z.ZodType<Prisma.TeacherUncheckedCreateNestedManyWithoutSchoolInput> = z.object({
  create: z.union([ z.lazy(() => TeacherCreateWithoutSchoolInputSchema),z.lazy(() => TeacherCreateWithoutSchoolInputSchema).array(),z.lazy(() => TeacherUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => TeacherUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => TeacherCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => TeacherCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => TeacherCreateManySchoolInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => TeacherWhereUniqueInputSchema),z.lazy(() => TeacherWhereUniqueInputSchema).array() ]).optional(),
...
export const BuildingUncheckedCreateNestedManyWithoutSchoolInputSchema: z.ZodType<Prisma.BuildingUncheckedCreateNestedManyWithoutSchoolInput> = z.object({
  create: z.union([ z.lazy(() => BuildingCreateWithoutSchoolInputSchema),z.lazy(() => BuildingCreateWithoutSchoolInputSchema).array(),z.lazy(() => BuildingUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => BuildingUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => BuildingCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => BuildingCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => BuildingCreateManySchoolInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => BuildingWhereUniqueInputSchema),z.lazy(() => BuildingWhereUniqueInputSchema).array() ]).optional(),
...
export const SchoolClassUpdateManyWithoutSchoolNestedInputSchema: z.ZodType<Prisma.SchoolClassUpdateManyWithoutSchoolNestedInput> = z.object({
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutSchoolInputSchema),z.lazy(() => SchoolClassCreateWithoutSchoolInputSchema).array(),z.lazy(() => SchoolClassUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SchoolClassCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => SchoolClassCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SchoolClassUpsertWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => SchoolClassUpsertWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SchoolClassCreateManySchoolInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => SchoolClassWhereUniqueInputSchema),z.lazy(() => SchoolClassWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => SchoolClassWhereUniqueInputSchema),z.lazy(() => SchoolClassWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => SchoolClassWhereUniqueInputSchema),z.lazy(() => SchoolClassWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => SchoolClassWhereUniqueInputSchema),z.lazy(() => SchoolClassWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => SchoolClassUpdateWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => SchoolClassUpdateWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => SchoolClassUpdateManyWithWhereWithoutSchoolInputSchema),z.lazy(() => SchoolClassUpdateManyWithWhereWithoutSchoolInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => SchoolClassScalarWhereInputSchema),z.lazy(() => SchoolClassScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const SubjectUpdateManyWithoutSchoolNestedInputSchema: z.ZodType<Prisma.SubjectUpdateManyWithoutSchoolNestedInput> = z.object({
  create: z.union([ z.lazy(() => SubjectCreateWithoutSchoolInputSchema),z.lazy(() => SubjectCreateWithoutSchoolInputSchema).array(),z.lazy(() => SubjectUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => SubjectUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubjectCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => SubjectCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SubjectUpsertWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => SubjectUpsertWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubjectCreateManySchoolInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => SubjectWhereUniqueInputSchema),z.lazy(() => SubjectWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => SubjectWhereUniqueInputSchema),z.lazy(() => SubjectWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => SubjectWhereUniqueInputSchema),z.lazy(() => SubjectWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => SubjectWhereUniqueInputSchema),z.lazy(() => SubjectWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => SubjectUpdateWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => SubjectUpdateWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => SubjectUpdateManyWithWhereWithoutSchoolInputSchema),z.lazy(() => SubjectUpdateManyWithWhereWithoutSchoolInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => SubjectScalarWhereInputSchema),z.lazy(() => SubjectScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const TeacherUpdateManyWithoutSchoolNestedInputSchema: z.ZodType<Prisma.TeacherUpdateManyWithoutSchoolNestedInput> = z.object({
  create: z.union([ z.lazy(() => TeacherCreateWithoutSchoolInputSchema),z.lazy(() => TeacherCreateWithoutSchoolInputSchema).array(),z.lazy(() => TeacherUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => TeacherUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => TeacherCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => TeacherCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => TeacherUpsertWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => TeacherUpsertWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => TeacherCreateManySchoolInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => TeacherWhereUniqueInputSchema),z.lazy(() => TeacherWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => TeacherWhereUniqueInputSchema),z.lazy(() => TeacherWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => TeacherWhereUniqueInputSchema),z.lazy(() => TeacherWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => TeacherWhereUniqueInputSchema),z.lazy(() => TeacherWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => TeacherUpdateWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => TeacherUpdateWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => TeacherUpdateManyWithWhereWithoutSchoolInputSchema),z.lazy(() => TeacherUpdateManyWithWhereWithoutSchoolInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => TeacherScalarWhereInputSchema),z.lazy(() => TeacherScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const BuildingUpdateManyWithoutSchoolNestedInputSchema: z.ZodType<Prisma.BuildingUpdateManyWithoutSchoolNestedInput> = z.object({
  create: z.union([ z.lazy(() => BuildingCreateWithoutSchoolInputSchema),z.lazy(() => BuildingCreateWithoutSchoolInputSchema).array(),z.lazy(() => BuildingUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => BuildingUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => BuildingCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => BuildingCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => BuildingUpsertWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => BuildingUpsertWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => BuildingCreateManySchoolInputEnvelopeSchema).optional(),
  ...
  connect: z.union([ z.lazy(() => BuildingWhereUniqueInputSchema),z.lazy(() => BuildingWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => BuildingUpdateWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => BuildingUpdateWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => BuildingUpdateManyWithWhereWithoutSchoolInputSchema),z.lazy(() => BuildingUpdateManyWithWhereWithoutSchoolInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => BuildingScalarWhereInputSchema),z.lazy(() => BuildingScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const SchoolClassUncheckedUpdateManyWithoutSchoolNestedInputSchema: z.ZodType<Prisma.SchoolClassUncheckedUpdateManyWithoutSchoolNestedInput> = z.object({
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutSchoolInputSchema),z.lazy(() => SchoolClassCreateWithoutSchoolInputSchema).array(),z.lazy(() => SchoolClassUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SchoolClassCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => SchoolClassCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SchoolClassUpsertWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => SchoolClassUpsertWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SchoolClassCreateManySchoolInputEnvelopeSchema).optional(),
...
export const SubjectUncheckedUpdateManyWithoutSchoolNestedInputSchema: z.ZodType<Prisma.SubjectUncheckedUpdateManyWithoutSchoolNestedInput> = z.object({
  create: z.union([ z.lazy(() => SubjectCreateWithoutSchoolInputSchema),z.lazy(() => SubjectCreateWithoutSchoolInputSchema).array(),z.lazy(() => SubjectUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => SubjectUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubjectCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => SubjectCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SubjectUpsertWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => SubjectUpsertWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubjectCreateManySchoolInputEnvelopeSchema).optional(),
...
export const TeacherUncheckedUpdateManyWithoutSchoolNestedInputSchema: z.ZodType<Prisma.TeacherUncheckedUpdateManyWithoutSchoolNestedInput> = z.object({
  create: z.union([ z.lazy(() => TeacherCreateWithoutSchoolInputSchema),z.lazy(() => TeacherCreateWithoutSchoolInputSchema).array(),z.lazy(() => TeacherUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => TeacherUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => TeacherCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => TeacherCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => TeacherUpsertWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => TeacherUpsertWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => TeacherCreateManySchoolInputEnvelopeSchema).optional(),
...
export const BuildingUncheckedUpdateManyWithoutSchoolNestedInputSchema: z.ZodType<Prisma.BuildingUncheckedUpdateManyWithoutSchoolNestedInput> = z.object({
  create: z.union([ z.lazy(() => BuildingCreateWithoutSchoolInputSchema),z.lazy(() => BuildingCreateWithoutSchoolInputSchema).array(),z.lazy(() => BuildingUncheckedCreateWithoutSchoolInputSchema),z.lazy(() => BuildingUncheckedCreateWithoutSchoolInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => BuildingCreateOrConnectWithoutSchoolInputSchema),z.lazy(() => BuildingCreateOrConnectWithoutSchoolInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => BuildingUpsertWithWhereUniqueWithoutSchoolInputSchema),z.lazy(() => BuildingUpsertWithWhereUniqueWithoutSchoolInputSchema).array() ]).optional(),
  createMany: z.lazy(() => BuildingCreateManySchoolInputEnvelopeSchema).optional(),
...
export const SchoolCreateNestedOneWithoutBuildingsInputSchema: z.ZodType<Prisma.SchoolCreateNestedOneWithoutBuildingsInput> = z.object({
  create: z.union([ z.lazy(() => SchoolCreateWithoutBuildingsInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutBuildingsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolCreateOrConnectWithoutBuildingsInputSchema).optional(),
  connect: z.lazy(() => SchoolWhereUniqueInputSchema).optional()
}).strict();
...
export const SchoolUpdateOneRequiredWithoutBuildingsNestedInputSchema: z.ZodType<Prisma.SchoolUpdateOneRequiredWithoutBuildingsNestedInput> = z.object({
  create: z.union([ z.lazy(() => SchoolCreateWithoutBuildingsInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutBuildingsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SchoolCreateOrConnectWithoutBuildingsInputSchema).optional(),
  upsert: z.lazy(() => SchoolUpsertWithoutBuildingsInputSchema).optional(),
  connect: z.lazy(() => SchoolWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => SchoolUpdateToOneWithWhereWithoutBuildingsInputSchema),z.lazy(() => SchoolUpdateWithoutBuildingsInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutBuildingsInputSchema) ]).optional(),
}).strict();
...
export const FloorCreateNestedOneWithoutRoomsInputSchema: z.ZodType<Prisma.FloorCreateNestedOneWithoutRoomsInput> = z.object({
  create: z.union([ z.lazy(() => FloorCreateWithoutRoomsInputSchema),z.lazy(() => FloorUncheckedCreateWithoutRoomsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => FloorCreateOrConnectWithoutRoomsInputSchema).optional(),
  connect: z.lazy(() => FloorWhereUniqueInputSchema).optional()
}).strict();

export const LessonCreateNestedManyWithoutRoomInputSchema: z.ZodType<Prisma.LessonCreateNestedManyWithoutRoomInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutRoomInputSchema),z.lazy(() => LessonCreateWithoutRoomInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutRoomInputSchema),z.lazy(() => LessonUncheckedCreateWithoutRoomInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutRoomInputSchema),z.lazy(() => LessonCreateOrConnectWithoutRoomInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyRoomInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const LessonUncheckedCreateNestedManyWithoutRoomInputSchema: z.ZodType<Prisma.LessonUncheckedCreateNestedManyWithoutRoomInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutRoomInputSchema),z.lazy(() => LessonCreateWithoutRoomInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutRoomInputSchema),z.lazy(() => LessonUncheckedCreateWithoutRoomInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutRoomInputSchema),z.lazy(() => LessonCreateOrConnectWithoutRoomInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyRoomInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
...
export const FloorUpdateOneRequiredWithoutRoomsNestedInputSchema: z.ZodType<Prisma.FloorUpdateOneRequiredWithoutRoomsNestedInput> = z.object({
  create: z.union([ z.lazy(() => FloorCreateWithoutRoomsInputSchema),z.lazy(() => FloorUncheckedCreateWithoutRoomsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => FloorCreateOrConnectWithoutRoomsInputSchema).optional(),
  upsert: z.lazy(() => FloorUpsertWithoutRoomsInputSchema).optional(),
  connect: z.lazy(() => FloorWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => FloorUpdateToOneWithWhereWithoutRoomsInputSchema),z.lazy(() => FloorUpdateWithoutRoomsInputSchema),z.lazy(() => FloorUncheckedUpdateWithoutRoomsInputSchema) ]).optional(),
}).strict();

export const LessonUpdateManyWithoutRoomNestedInputSchema: z.ZodType<Prisma.LessonUpdateManyWithoutRoomNestedInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutRoomInputSchema),z.lazy(() => LessonCreateWithoutRoomInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutRoomInputSchema),z.lazy(() => LessonUncheckedCreateWithoutRoomInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutRoomInputSchema),z.lazy(() => LessonCreateOrConnectWithoutRoomInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LessonUpsertWithWhereUniqueWithoutRoomInputSchema),z.lazy(() => LessonUpsertWithWhereUniqueWithoutRoomInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyRoomInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => LessonWhereUniqueInputSchema),z.lazy(() => LessonWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => LessonUpdateWithWhereUniqueWithoutRoomInputSchema),z.lazy(() => LessonUpdateWithWhereUniqueWithoutRoomInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LessonUpdateManyWithWhereWithoutRoomInputSchema),z.lazy(() => LessonUpdateManyWithWhereWithoutRoomInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LessonScalarWhereInputSchema),z.lazy(() => LessonScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const LessonUncheckedUpdateManyWithoutRoomNestedInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateManyWithoutRoomNestedInput> = z.object({
  create: z.union([ z.lazy(() => LessonCreateWithoutRoomInputSchema),z.lazy(() => LessonCreateWithoutRoomInputSchema).array(),z.lazy(() => LessonUncheckedCreateWithoutRoomInputSchema),z.lazy(() => LessonUncheckedCreateWithoutRoomInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LessonCreateOrConnectWithoutRoomInputSchema),z.lazy(() => LessonCreateOrConnectWithoutRoomInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LessonUpsertWithWhereUniqueWithoutRoomInputSchema),z.lazy(() => LessonUpsertWithWhereUniqueWithoutRoomInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LessonCreateManyRoomInputEnvelopeSchema).optional(),
...
export const NestedEnumLessonWeekFilterSchema: z.ZodType<Prisma.NestedEnumLessonWeekFilter> = z.object({
  equals: z.lazy(() => LessonWeekSchema).optional(),
  in: z.lazy(() => LessonWeekSchema).array().optional(),
  notIn: z.lazy(() => LessonWeekSchema).array().optional(),
  not: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => NestedEnumLessonWeekFilterSchema) ]).optional(),
...
export const NestedEnumLessonWeekWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumLessonWeekWithAggregatesFilter> = z.object({
  equals: z.lazy(() => LessonWeekSchema).optional(),
  in: z.lazy(() => LessonWeekSchema).array().optional(),
  notIn: z.lazy(() => LessonWeekSchema).array().optional(),
  not: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => NestedEnumLessonWeekWithAggregatesFilterSchema) ]).optional(),
...
export const SchoolCreateOrConnectWithoutTeachersInputSchema: z.ZodType<Prisma.SchoolCreateOrConnectWithoutTeachersInput> = z.object({
  where: z.lazy(() => SchoolWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SchoolCreateWithoutTeachersInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutTeachersInputSchema) ]),
}).strict();

export const LessonCreateWithoutTeacherInputSchema: z.ZodType<Prisma.LessonCreateWithoutTeacherInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonUncheckedCreateWithoutTeacherInputSchema: z.ZodType<Prisma.LessonUncheckedCreateWithoutTeacherInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonCreateOrConnectWithoutTeacherInputSchema: z.ZodType<Prisma.LessonCreateOrConnectWithoutTeacherInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => LessonCreateWithoutTeacherInputSchema),z.lazy(() => LessonUncheckedCreateWithoutTeacherInputSchema) ]),
}).strict();

export const LessonCreateManyTeacherInputEnvelopeSchema: z.ZodType<Prisma.LessonCreateManyTeacherInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => LessonCreateManyTeacherInputSchema),z.lazy(() => LessonCreateManyTeacherInputSchema).array() ]),
}).strict();
...
export const SchoolUpsertWithoutTeachersInputSchema: z.ZodType<Prisma.SchoolUpsertWithoutTeachersInput> = z.object({
  update: z.union([ z.lazy(() => SchoolUpdateWithoutTeachersInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutTeachersInputSchema) ]),
  create: z.union([ z.lazy(() => SchoolCreateWithoutTeachersInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutTeachersInputSchema) ]),
  where: z.lazy(() => SchoolWhereInputSchema).optional()
}).strict();

export const SchoolUpdateToOneWithWhereWithoutTeachersInputSchema: z.ZodType<Prisma.SchoolUpdateToOneWithWhereWithoutTeachersInput> = z.object({
  where: z.lazy(() => SchoolWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => SchoolUpdateWithoutTeachersInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutTeachersInputSchema) ]),
}).strict();
...
export const LessonUpsertWithWhereUniqueWithoutTeacherInputSchema: z.ZodType<Prisma.LessonUpsertWithWhereUniqueWithoutTeacherInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LessonUpdateWithoutTeacherInputSchema),z.lazy(() => LessonUncheckedUpdateWithoutTeacherInputSchema) ]),
  create: z.union([ z.lazy(() => LessonCreateWithoutTeacherInputSchema),z.lazy(() => LessonUncheckedCreateWithoutTeacherInputSchema) ]),
}).strict();

export const LessonUpdateWithWhereUniqueWithoutTeacherInputSchema: z.ZodType<Prisma.LessonUpdateWithWhereUniqueWithoutTeacherInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LessonUpdateWithoutTeacherInputSchema),z.lazy(() => LessonUncheckedUpdateWithoutTeacherInputSchema) ]),
}).strict();

export const LessonUpdateManyWithWhereWithoutTeacherInputSchema: z.ZodType<Prisma.LessonUpdateManyWithWhereWithoutTeacherInput> = z.object({
  where: z.lazy(() => LessonScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LessonUpdateManyMutationInputSchema),z.lazy(() => LessonUncheckedUpdateManyWithoutTeacherInputSchema) ]),
}).strict();
...
export const SchoolClassCreateWithoutStudentsInputSchema: z.ZodType<Prisma.SchoolClassCreateWithoutStudentsInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const SchoolClassUncheckedCreateWithoutStudentsInputSchema: z.ZodType<Prisma.SchoolClassUncheckedCreateWithoutStudentsInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  schoolId: z.string(),
  createdAt: z.coerce.date().optional(),
...
export const SchoolClassCreateOrConnectWithoutStudentsInputSchema: z.ZodType<Prisma.SchoolClassCreateOrConnectWithoutStudentsInput> = z.object({
  where: z.lazy(() => SchoolClassWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutStudentsInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutStudentsInputSchema) ]),
}).strict();

export const SchoolClassUpsertWithoutStudentsInputSchema: z.ZodType<Prisma.SchoolClassUpsertWithoutStudentsInput> = z.object({
  update: z.union([ z.lazy(() => SchoolClassUpdateWithoutStudentsInputSchema),z.lazy(() => SchoolClassUncheckedUpdateWithoutStudentsInputSchema) ]),
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutStudentsInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutStudentsInputSchema) ]),
  where: z.lazy(() => SchoolClassWhereInputSchema).optional()
}).strict();

export const SchoolClassUpdateToOneWithWhereWithoutStudentsInputSchema: z.ZodType<Prisma.SchoolClassUpdateToOneWithWhereWithoutStudentsInput> = z.object({
  where: z.lazy(() => SchoolClassWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => SchoolClassUpdateWithoutStudentsInputSchema),z.lazy(() => SchoolClassUncheckedUpdateWithoutStudentsInputSchema) ]),
}).strict();

export const SchoolClassUpdateWithoutStudentsInputSchema: z.ZodType<Prisma.SchoolClassUpdateWithoutStudentsInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  school: z.lazy(() => SchoolUpdateOneRequiredWithoutClassesNestedInputSchema).optional(),
...
export const SchoolClassUncheckedUpdateWithoutStudentsInputSchema: z.ZodType<Prisma.SchoolClassUncheckedUpdateWithoutStudentsInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  schoolId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SchoolCreateOrConnectWithoutSubjectsInputSchema: z.ZodType<Prisma.SchoolCreateOrConnectWithoutSubjectsInput> = z.object({
  where: z.lazy(() => SchoolWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SchoolCreateWithoutSubjectsInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutSubjectsInputSchema) ]),
}).strict();

export const LessonCreateWithoutSubjectInputSchema: z.ZodType<Prisma.LessonCreateWithoutSubjectInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonUncheckedCreateWithoutSubjectInputSchema: z.ZodType<Prisma.LessonUncheckedCreateWithoutSubjectInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonCreateOrConnectWithoutSubjectInputSchema: z.ZodType<Prisma.LessonCreateOrConnectWithoutSubjectInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => LessonCreateWithoutSubjectInputSchema),z.lazy(() => LessonUncheckedCreateWithoutSubjectInputSchema) ]),
}).strict();

export const LessonCreateManySubjectInputEnvelopeSchema: z.ZodType<Prisma.LessonCreateManySubjectInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => LessonCreateManySubjectInputSchema),z.lazy(() => LessonCreateManySubjectInputSchema).array() ]),
}).strict();
...
export const SchoolUpsertWithoutSubjectsInputSchema: z.ZodType<Prisma.SchoolUpsertWithoutSubjectsInput> = z.object({
  update: z.union([ z.lazy(() => SchoolUpdateWithoutSubjectsInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutSubjectsInputSchema) ]),
  create: z.union([ z.lazy(() => SchoolCreateWithoutSubjectsInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutSubjectsInputSchema) ]),
  where: z.lazy(() => SchoolWhereInputSchema).optional()
}).strict();

export const SchoolUpdateToOneWithWhereWithoutSubjectsInputSchema: z.ZodType<Prisma.SchoolUpdateToOneWithWhereWithoutSubjectsInput> = z.object({
  where: z.lazy(() => SchoolWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => SchoolUpdateWithoutSubjectsInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutSubjectsInputSchema) ]),
}).strict();
...
export const LessonUpsertWithWhereUniqueWithoutSubjectInputSchema: z.ZodType<Prisma.LessonUpsertWithWhereUniqueWithoutSubjectInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LessonUpdateWithoutSubjectInputSchema),z.lazy(() => LessonUncheckedUpdateWithoutSubjectInputSchema) ]),
  create: z.union([ z.lazy(() => LessonCreateWithoutSubjectInputSchema),z.lazy(() => LessonUncheckedCreateWithoutSubjectInputSchema) ]),
}).strict();

export const LessonUpdateWithWhereUniqueWithoutSubjectInputSchema: z.ZodType<Prisma.LessonUpdateWithWhereUniqueWithoutSubjectInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LessonUpdateWithoutSubjectInputSchema),z.lazy(() => LessonUncheckedUpdateWithoutSubjectInputSchema) ]),
}).strict();

export const LessonUpdateManyWithWhereWithoutSubjectInputSchema: z.ZodType<Prisma.LessonUpdateManyWithWhereWithoutSubjectInput> = z.object({
  where: z.lazy(() => LessonScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LessonUpdateManyMutationInputSchema),z.lazy(() => LessonUncheckedUpdateManyWithoutSubjectInputSchema) ]),
}).strict();
...
export const RoomCreateWithoutLessonsInputSchema: z.ZodType<Prisma.RoomCreateWithoutLessonsInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const RoomUncheckedCreateWithoutLessonsInputSchema: z.ZodType<Prisma.RoomUncheckedCreateWithoutLessonsInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  floorId: z.string(),
  createdAt: z.coerce.date().optional(),
...
export const RoomCreateOrConnectWithoutLessonsInputSchema: z.ZodType<Prisma.RoomCreateOrConnectWithoutLessonsInput> = z.object({
  where: z.lazy(() => RoomWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => RoomCreateWithoutLessonsInputSchema),z.lazy(() => RoomUncheckedCreateWithoutLessonsInputSchema) ]),
}).strict();

export const TeacherCreateWithoutLessonsInputSchema: z.ZodType<Prisma.TeacherCreateWithoutLessonsInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const TeacherUncheckedCreateWithoutLessonsInputSchema: z.ZodType<Prisma.TeacherUncheckedCreateWithoutLessonsInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  schoolId: z.string(),
  subjectIds: z.union([ z.lazy(() => TeacherCreatesubjectIdsInputSchema),z.string().array() ]).optional(),
...
export const TeacherCreateOrConnectWithoutLessonsInputSchema: z.ZodType<Prisma.TeacherCreateOrConnectWithoutLessonsInput> = z.object({
  where: z.lazy(() => TeacherWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => TeacherCreateWithoutLessonsInputSchema),z.lazy(() => TeacherUncheckedCreateWithoutLessonsInputSchema) ]),
}).strict();

export const SubjectCreateWithoutLessonsInputSchema: z.ZodType<Prisma.SubjectCreateWithoutLessonsInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const SubjectUncheckedCreateWithoutLessonsInputSchema: z.ZodType<Prisma.SubjectUncheckedCreateWithoutLessonsInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  schoolId: z.string(),
  teacherIds: z.union([ z.lazy(() => SubjectCreateteacherIdsInputSchema),z.string().array() ]).optional(),
...
export const SubjectCreateOrConnectWithoutLessonsInputSchema: z.ZodType<Prisma.SubjectCreateOrConnectWithoutLessonsInput> = z.object({
  where: z.lazy(() => SubjectWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SubjectCreateWithoutLessonsInputSchema),z.lazy(() => SubjectUncheckedCreateWithoutLessonsInputSchema) ]),
}).strict();

export const ScheduleCreateWithoutLessonsInputSchema: z.ZodType<Prisma.ScheduleCreateWithoutLessonsInput> = z.object({
  id: z.string().optional(),
  day: z.lazy(() => DaySchema),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const ScheduleUncheckedCreateWithoutLessonsInputSchema: z.ZodType<Prisma.ScheduleUncheckedCreateWithoutLessonsInput> = z.object({
  id: z.string().optional(),
  day: z.lazy(() => DaySchema),
  classId: z.string(),
  createdAt: z.coerce.date().optional(),
...
export const ScheduleCreateOrConnectWithoutLessonsInputSchema: z.ZodType<Prisma.ScheduleCreateOrConnectWithoutLessonsInput> = z.object({
  where: z.lazy(() => ScheduleWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ScheduleCreateWithoutLessonsInputSchema),z.lazy(() => ScheduleUncheckedCreateWithoutLessonsInputSchema) ]),
}).strict();

export const RoomUpsertWithoutLessonsInputSchema: z.ZodType<Prisma.RoomUpsertWithoutLessonsInput> = z.object({
  update: z.union([ z.lazy(() => RoomUpdateWithoutLessonsInputSchema),z.lazy(() => RoomUncheckedUpdateWithoutLessonsInputSchema) ]),
  create: z.union([ z.lazy(() => RoomCreateWithoutLessonsInputSchema),z.lazy(() => RoomUncheckedCreateWithoutLessonsInputSchema) ]),
  where: z.lazy(() => RoomWhereInputSchema).optional()
}).strict();

export const RoomUpdateToOneWithWhereWithoutLessonsInputSchema: z.ZodType<Prisma.RoomUpdateToOneWithWhereWithoutLessonsInput> = z.object({
  where: z.lazy(() => RoomWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => RoomUpdateWithoutLessonsInputSchema),z.lazy(() => RoomUncheckedUpdateWithoutLessonsInputSchema) ]),
}).strict();

export const RoomUpdateWithoutLessonsInputSchema: z.ZodType<Prisma.RoomUpdateWithoutLessonsInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  floor: z.lazy(() => FloorUpdateOneRequiredWithoutRoomsNestedInputSchema).optional()
...
export const RoomUncheckedUpdateWithoutLessonsInputSchema: z.ZodType<Prisma.RoomUncheckedUpdateWithoutLessonsInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  floorId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const TeacherUpsertWithoutLessonsInputSchema: z.ZodType<Prisma.TeacherUpsertWithoutLessonsInput> = z.object({
  update: z.union([ z.lazy(() => TeacherUpdateWithoutLessonsInputSchema),z.lazy(() => TeacherUncheckedUpdateWithoutLessonsInputSchema) ]),
  create: z.union([ z.lazy(() => TeacherCreateWithoutLessonsInputSchema),z.lazy(() => TeacherUncheckedCreateWithoutLessonsInputSchema) ]),
  where: z.lazy(() => TeacherWhereInputSchema).optional()
}).strict();

export const TeacherUpdateToOneWithWhereWithoutLessonsInputSchema: z.ZodType<Prisma.TeacherUpdateToOneWithWhereWithoutLessonsInput> = z.object({
  where: z.lazy(() => TeacherWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => TeacherUpdateWithoutLessonsInputSchema),z.lazy(() => TeacherUncheckedUpdateWithoutLessonsInputSchema) ]),
}).strict();

export const TeacherUpdateWithoutLessonsInputSchema: z.ZodType<Prisma.TeacherUpdateWithoutLessonsInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  school: z.lazy(() => SchoolUpdateOneRequiredWithoutTeachersNestedInputSchema).optional(),
...
export const TeacherUncheckedUpdateWithoutLessonsInputSchema: z.ZodType<Prisma.TeacherUncheckedUpdateWithoutLessonsInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  schoolId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  subjectIds: z.union([ z.lazy(() => TeacherUpdatesubjectIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SubjectUpsertWithoutLessonsInputSchema: z.ZodType<Prisma.SubjectUpsertWithoutLessonsInput> = z.object({
  update: z.union([ z.lazy(() => SubjectUpdateWithoutLessonsInputSchema),z.lazy(() => SubjectUncheckedUpdateWithoutLessonsInputSchema) ]),
  create: z.union([ z.lazy(() => SubjectCreateWithoutLessonsInputSchema),z.lazy(() => SubjectUncheckedCreateWithoutLessonsInputSchema) ]),
  where: z.lazy(() => SubjectWhereInputSchema).optional()
}).strict();

export const SubjectUpdateToOneWithWhereWithoutLessonsInputSchema: z.ZodType<Prisma.SubjectUpdateToOneWithWhereWithoutLessonsInput> = z.object({
  where: z.lazy(() => SubjectWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => SubjectUpdateWithoutLessonsInputSchema),z.lazy(() => SubjectUncheckedUpdateWithoutLessonsInputSchema) ]),
}).strict();

export const SubjectUpdateWithoutLessonsInputSchema: z.ZodType<Prisma.SubjectUpdateWithoutLessonsInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  school: z.lazy(() => SchoolUpdateOneRequiredWithoutSubjectsNestedInputSchema).optional(),
...
export const SubjectUncheckedUpdateWithoutLessonsInputSchema: z.ZodType<Prisma.SubjectUncheckedUpdateWithoutLessonsInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  schoolId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  teacherIds: z.union([ z.lazy(() => SubjectUpdateteacherIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ScheduleUpsertWithoutLessonsInputSchema: z.ZodType<Prisma.ScheduleUpsertWithoutLessonsInput> = z.object({
  update: z.union([ z.lazy(() => ScheduleUpdateWithoutLessonsInputSchema),z.lazy(() => ScheduleUncheckedUpdateWithoutLessonsInputSchema) ]),
  create: z.union([ z.lazy(() => ScheduleCreateWithoutLessonsInputSchema),z.lazy(() => ScheduleUncheckedCreateWithoutLessonsInputSchema) ]),
  where: z.lazy(() => ScheduleWhereInputSchema).optional()
}).strict();

export const ScheduleUpdateToOneWithWhereWithoutLessonsInputSchema: z.ZodType<Prisma.ScheduleUpdateToOneWithWhereWithoutLessonsInput> = z.object({
  where: z.lazy(() => ScheduleWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ScheduleUpdateWithoutLessonsInputSchema),z.lazy(() => ScheduleUncheckedUpdateWithoutLessonsInputSchema) ]),
}).strict();

export const ScheduleUpdateWithoutLessonsInputSchema: z.ZodType<Prisma.ScheduleUpdateWithoutLessonsInput> = z.object({
  day: z.union([ z.lazy(() => DaySchema),z.lazy(() => EnumDayFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  class: z.lazy(() => SchoolClassUpdateOneRequiredWithoutWeeklyScheduleNestedInputSchema).optional()
...
export const ScheduleUncheckedUpdateWithoutLessonsInputSchema: z.ZodType<Prisma.ScheduleUncheckedUpdateWithoutLessonsInput> = z.object({
  day: z.union([ z.lazy(() => DaySchema),z.lazy(() => EnumDayFieldUpdateOperationsInputSchema) ]).optional(),
  classId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SchoolClassCreateWithoutWeeklyScheduleInputSchema: z.ZodType<Prisma.SchoolClassCreateWithoutWeeklyScheduleInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const SchoolClassUncheckedCreateWithoutWeeklyScheduleInputSchema: z.ZodType<Prisma.SchoolClassUncheckedCreateWithoutWeeklyScheduleInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  schoolId: z.string(),
  createdAt: z.coerce.date().optional(),
...
export const SchoolClassCreateOrConnectWithoutWeeklyScheduleInputSchema: z.ZodType<Prisma.SchoolClassCreateOrConnectWithoutWeeklyScheduleInput> = z.object({
  where: z.lazy(() => SchoolClassWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutWeeklyScheduleInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutWeeklyScheduleInputSchema) ]),
}).strict();

export const LessonCreateWithoutScheduleInputSchema: z.ZodType<Prisma.LessonCreateWithoutScheduleInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonUncheckedCreateWithoutScheduleInputSchema: z.ZodType<Prisma.LessonUncheckedCreateWithoutScheduleInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonCreateOrConnectWithoutScheduleInputSchema: z.ZodType<Prisma.LessonCreateOrConnectWithoutScheduleInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => LessonCreateWithoutScheduleInputSchema),z.lazy(() => LessonUncheckedCreateWithoutScheduleInputSchema) ]),
}).strict();

export const LessonCreateManyScheduleInputEnvelopeSchema: z.ZodType<Prisma.LessonCreateManyScheduleInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => LessonCreateManyScheduleInputSchema),z.lazy(() => LessonCreateManyScheduleInputSchema).array() ]),
}).strict();

export const SchoolClassUpsertWithoutWeeklyScheduleInputSchema: z.ZodType<Prisma.SchoolClassUpsertWithoutWeeklyScheduleInput> = z.object({
  update: z.union([ z.lazy(() => SchoolClassUpdateWithoutWeeklyScheduleInputSchema),z.lazy(() => SchoolClassUncheckedUpdateWithoutWeeklyScheduleInputSchema) ]),
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutWeeklyScheduleInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutWeeklyScheduleInputSchema) ]),
  where: z.lazy(() => SchoolClassWhereInputSchema).optional()
}).strict();

export const SchoolClassUpdateToOneWithWhereWithoutWeeklyScheduleInputSchema: z.ZodType<Prisma.SchoolClassUpdateToOneWithWhereWithoutWeeklyScheduleInput> = z.object({
  where: z.lazy(() => SchoolClassWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => SchoolClassUpdateWithoutWeeklyScheduleInputSchema),z.lazy(() => SchoolClassUncheckedUpdateWithoutWeeklyScheduleInputSchema) ]),
}).strict();

export const SchoolClassUpdateWithoutWeeklyScheduleInputSchema: z.ZodType<Prisma.SchoolClassUpdateWithoutWeeklyScheduleInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  school: z.lazy(() => SchoolUpdateOneRequiredWithoutClassesNestedInputSchema).optional(),
...
export const SchoolClassUncheckedUpdateWithoutWeeklyScheduleInputSchema: z.ZodType<Prisma.SchoolClassUncheckedUpdateWithoutWeeklyScheduleInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  schoolId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LessonUpsertWithWhereUniqueWithoutScheduleInputSchema: z.ZodType<Prisma.LessonUpsertWithWhereUniqueWithoutScheduleInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LessonUpdateWithoutScheduleInputSchema),z.lazy(() => LessonUncheckedUpdateWithoutScheduleInputSchema) ]),
  create: z.union([ z.lazy(() => LessonCreateWithoutScheduleInputSchema),z.lazy(() => LessonUncheckedCreateWithoutScheduleInputSchema) ]),
}).strict();

export const LessonUpdateWithWhereUniqueWithoutScheduleInputSchema: z.ZodType<Prisma.LessonUpdateWithWhereUniqueWithoutScheduleInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LessonUpdateWithoutScheduleInputSchema),z.lazy(() => LessonUncheckedUpdateWithoutScheduleInputSchema) ]),
}).strict();

export const LessonUpdateManyWithWhereWithoutScheduleInputSchema: z.ZodType<Prisma.LessonUpdateManyWithWhereWithoutScheduleInput> = z.object({
  where: z.lazy(() => LessonScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LessonUpdateManyMutationInputSchema),z.lazy(() => LessonUncheckedUpdateManyWithoutScheduleInputSchema) ]),
}).strict();
...
export const SchoolCreateOrConnectWithoutClassesInputSchema: z.ZodType<Prisma.SchoolCreateOrConnectWithoutClassesInput> = z.object({
  where: z.lazy(() => SchoolWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SchoolCreateWithoutClassesInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutClassesInputSchema) ]),
}).strict();

export const StudentCreateWithoutClassInputSchema: z.ZodType<Prisma.StudentCreateWithoutClassInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const StudentUncheckedCreateWithoutClassInputSchema: z.ZodType<Prisma.StudentUncheckedCreateWithoutClassInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const StudentCreateOrConnectWithoutClassInputSchema: z.ZodType<Prisma.StudentCreateOrConnectWithoutClassInput> = z.object({
  where: z.lazy(() => StudentWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => StudentCreateWithoutClassInputSchema),z.lazy(() => StudentUncheckedCreateWithoutClassInputSchema) ]),
}).strict();

export const StudentCreateManyClassInputEnvelopeSchema: z.ZodType<Prisma.StudentCreateManyClassInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => StudentCreateManyClassInputSchema),z.lazy(() => StudentCreateManyClassInputSchema).array() ]),
}).strict();

export const ScheduleCreateWithoutClassInputSchema: z.ZodType<Prisma.ScheduleCreateWithoutClassInput> = z.object({
  id: z.string().optional(),
  day: z.lazy(() => DaySchema),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const ScheduleUncheckedCreateWithoutClassInputSchema: z.ZodType<Prisma.ScheduleUncheckedCreateWithoutClassInput> = z.object({
  id: z.string().optional(),
  day: z.lazy(() => DaySchema),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const ScheduleCreateOrConnectWithoutClassInputSchema: z.ZodType<Prisma.ScheduleCreateOrConnectWithoutClassInput> = z.object({
  where: z.lazy(() => ScheduleWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ScheduleCreateWithoutClassInputSchema),z.lazy(() => ScheduleUncheckedCreateWithoutClassInputSchema) ]),
}).strict();

export const ScheduleCreateManyClassInputEnvelopeSchema: z.ZodType<Prisma.ScheduleCreateManyClassInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => ScheduleCreateManyClassInputSchema),z.lazy(() => ScheduleCreateManyClassInputSchema).array() ]),
}).strict();

export const SchoolUpsertWithoutClassesInputSchema: z.ZodType<Prisma.SchoolUpsertWithoutClassesInput> = z.object({
  update: z.union([ z.lazy(() => SchoolUpdateWithoutClassesInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutClassesInputSchema) ]),
  create: z.union([ z.lazy(() => SchoolCreateWithoutClassesInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutClassesInputSchema) ]),
  where: z.lazy(() => SchoolWhereInputSchema).optional()
}).strict();

export const SchoolUpdateToOneWithWhereWithoutClassesInputSchema: z.ZodType<Prisma.SchoolUpdateToOneWithWhereWithoutClassesInput> = z.object({
  where: z.lazy(() => SchoolWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => SchoolUpdateWithoutClassesInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutClassesInputSchema) ]),
}).strict();
...
export const StudentUpsertWithWhereUniqueWithoutClassInputSchema: z.ZodType<Prisma.StudentUpsertWithWhereUniqueWithoutClassInput> = z.object({
  where: z.lazy(() => StudentWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => StudentUpdateWithoutClassInputSchema),z.lazy(() => StudentUncheckedUpdateWithoutClassInputSchema) ]),
  create: z.union([ z.lazy(() => StudentCreateWithoutClassInputSchema),z.lazy(() => StudentUncheckedCreateWithoutClassInputSchema) ]),
}).strict();

export const StudentUpdateWithWhereUniqueWithoutClassInputSchema: z.ZodType<Prisma.StudentUpdateWithWhereUniqueWithoutClassInput> = z.object({
  where: z.lazy(() => StudentWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => StudentUpdateWithoutClassInputSchema),z.lazy(() => StudentUncheckedUpdateWithoutClassInputSchema) ]),
}).strict();

export const StudentUpdateManyWithWhereWithoutClassInputSchema: z.ZodType<Prisma.StudentUpdateManyWithWhereWithoutClassInput> = z.object({
  where: z.lazy(() => StudentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => StudentUpdateManyMutationInputSchema),z.lazy(() => StudentUncheckedUpdateManyWithoutClassInputSchema) ]),
}).strict();
...
export const ScheduleUpsertWithWhereUniqueWithoutClassInputSchema: z.ZodType<Prisma.ScheduleUpsertWithWhereUniqueWithoutClassInput> = z.object({
  where: z.lazy(() => ScheduleWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ScheduleUpdateWithoutClassInputSchema),z.lazy(() => ScheduleUncheckedUpdateWithoutClassInputSchema) ]),
  create: z.union([ z.lazy(() => ScheduleCreateWithoutClassInputSchema),z.lazy(() => ScheduleUncheckedCreateWithoutClassInputSchema) ]),
}).strict();

export const ScheduleUpdateWithWhereUniqueWithoutClassInputSchema: z.ZodType<Prisma.ScheduleUpdateWithWhereUniqueWithoutClassInput> = z.object({
  where: z.lazy(() => ScheduleWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ScheduleUpdateWithoutClassInputSchema),z.lazy(() => ScheduleUncheckedUpdateWithoutClassInputSchema) ]),
}).strict();

export const ScheduleUpdateManyWithWhereWithoutClassInputSchema: z.ZodType<Prisma.ScheduleUpdateManyWithWhereWithoutClassInput> = z.object({
  where: z.lazy(() => ScheduleScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ScheduleUpdateManyMutationInputSchema),z.lazy(() => ScheduleUncheckedUpdateManyWithoutClassInputSchema) ]),
}).strict();
...
export const SchoolClassCreateWithoutSchoolInputSchema: z.ZodType<Prisma.SchoolClassCreateWithoutSchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const SchoolClassUncheckedCreateWithoutSchoolInputSchema: z.ZodType<Prisma.SchoolClassUncheckedCreateWithoutSchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const SchoolClassCreateOrConnectWithoutSchoolInputSchema: z.ZodType<Prisma.SchoolClassCreateOrConnectWithoutSchoolInput> = z.object({
  where: z.lazy(() => SchoolClassWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutSchoolInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutSchoolInputSchema) ]),
}).strict();

export const SchoolClassCreateManySchoolInputEnvelopeSchema: z.ZodType<Prisma.SchoolClassCreateManySchoolInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => SchoolClassCreateManySchoolInputSchema),z.lazy(() => SchoolClassCreateManySchoolInputSchema).array() ]),
}).strict();

export const SubjectCreateWithoutSchoolInputSchema: z.ZodType<Prisma.SubjectCreateWithoutSchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const SubjectUncheckedCreateWithoutSchoolInputSchema: z.ZodType<Prisma.SubjectUncheckedCreateWithoutSchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  teacherIds: z.union([ z.lazy(() => SubjectCreateteacherIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.coerce.date().optional(),
...
export const SubjectCreateOrConnectWithoutSchoolInputSchema: z.ZodType<Prisma.SubjectCreateOrConnectWithoutSchoolInput> = z.object({
  where: z.lazy(() => SubjectWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SubjectCreateWithoutSchoolInputSchema),z.lazy(() => SubjectUncheckedCreateWithoutSchoolInputSchema) ]),
}).strict();

export const SubjectCreateManySchoolInputEnvelopeSchema: z.ZodType<Prisma.SubjectCreateManySchoolInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => SubjectCreateManySchoolInputSchema),z.lazy(() => SubjectCreateManySchoolInputSchema).array() ]),
}).strict();

export const TeacherCreateWithoutSchoolInputSchema: z.ZodType<Prisma.TeacherCreateWithoutSchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const TeacherUncheckedCreateWithoutSchoolInputSchema: z.ZodType<Prisma.TeacherUncheckedCreateWithoutSchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  subjectIds: z.union([ z.lazy(() => TeacherCreatesubjectIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.coerce.date().optional(),
...
export const TeacherCreateOrConnectWithoutSchoolInputSchema: z.ZodType<Prisma.TeacherCreateOrConnectWithoutSchoolInput> = z.object({
  where: z.lazy(() => TeacherWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => TeacherCreateWithoutSchoolInputSchema),z.lazy(() => TeacherUncheckedCreateWithoutSchoolInputSchema) ]),
}).strict();

export const TeacherCreateManySchoolInputEnvelopeSchema: z.ZodType<Prisma.TeacherCreateManySchoolInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => TeacherCreateManySchoolInputSchema),z.lazy(() => TeacherCreateManySchoolInputSchema).array() ]),
}).strict();

export const BuildingCreateWithoutSchoolInputSchema: z.ZodType<Prisma.BuildingCreateWithoutSchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const BuildingUncheckedCreateWithoutSchoolInputSchema: z.ZodType<Prisma.BuildingUncheckedCreateWithoutSchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const BuildingCreateOrConnectWithoutSchoolInputSchema: z.ZodType<Prisma.BuildingCreateOrConnectWithoutSchoolInput> = z.object({
  where: z.lazy(() => BuildingWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => BuildingCreateWithoutSchoolInputSchema),z.lazy(() => BuildingUncheckedCreateWithoutSchoolInputSchema) ]),
}).strict();

export const BuildingCreateManySchoolInputEnvelopeSchema: z.ZodType<Prisma.BuildingCreateManySchoolInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => BuildingCreateManySchoolInputSchema),z.lazy(() => BuildingCreateManySchoolInputSchema).array() ]),
}).strict();

export const SchoolClassUpsertWithWhereUniqueWithoutSchoolInputSchema: z.ZodType<Prisma.SchoolClassUpsertWithWhereUniqueWithoutSchoolInput> = z.object({
  where: z.lazy(() => SchoolClassWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => SchoolClassUpdateWithoutSchoolInputSchema),z.lazy(() => SchoolClassUncheckedUpdateWithoutSchoolInputSchema) ]),
  create: z.union([ z.lazy(() => SchoolClassCreateWithoutSchoolInputSchema),z.lazy(() => SchoolClassUncheckedCreateWithoutSchoolInputSchema) ]),
}).strict();

export const SchoolClassUpdateWithWhereUniqueWithoutSchoolInputSchema: z.ZodType<Prisma.SchoolClassUpdateWithWhereUniqueWithoutSchoolInput> = z.object({
  where: z.lazy(() => SchoolClassWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => SchoolClassUpdateWithoutSchoolInputSchema),z.lazy(() => SchoolClassUncheckedUpdateWithoutSchoolInputSchema) ]),
}).strict();

export const SchoolClassUpdateManyWithWhereWithoutSchoolInputSchema: z.ZodType<Prisma.SchoolClassUpdateManyWithWhereWithoutSchoolInput> = z.object({
  where: z.lazy(() => SchoolClassScalarWhereInputSchema),
  data: z.union([ z.lazy(() => SchoolClassUpdateManyMutationInputSchema),z.lazy(() => SchoolClassUncheckedUpdateManyWithoutSchoolInputSchema) ]),
}).strict();

export const SchoolClassScalarWhereInputSchema: z.ZodType<Prisma.SchoolClassScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => SchoolClassScalarWhereInputSchema),z.lazy(() => SchoolClassScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => SchoolClassScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => SchoolClassScalarWhereInputSchema),z.lazy(() => SchoolClassScalarWhereInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  schoolId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
...
export const SubjectUpsertWithWhereUniqueWithoutSchoolInputSchema: z.ZodType<Prisma.SubjectUpsertWithWhereUniqueWithoutSchoolInput> = z.object({
  where: z.lazy(() => SubjectWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => SubjectUpdateWithoutSchoolInputSchema),z.lazy(() => SubjectUncheckedUpdateWithoutSchoolInputSchema) ]),
  create: z.union([ z.lazy(() => SubjectCreateWithoutSchoolInputSchema),z.lazy(() => SubjectUncheckedCreateWithoutSchoolInputSchema) ]),
}).strict();

export const SubjectUpdateWithWhereUniqueWithoutSchoolInputSchema: z.ZodType<Prisma.SubjectUpdateWithWhereUniqueWithoutSchoolInput> = z.object({
  where: z.lazy(() => SubjectWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => SubjectUpdateWithoutSchoolInputSchema),z.lazy(() => SubjectUncheckedUpdateWithoutSchoolInputSchema) ]),
}).strict();

export const SubjectUpdateManyWithWhereWithoutSchoolInputSchema: z.ZodType<Prisma.SubjectUpdateManyWithWhereWithoutSchoolInput> = z.object({
  where: z.lazy(() => SubjectScalarWhereInputSchema),
  data: z.union([ z.lazy(() => SubjectUpdateManyMutationInputSchema),z.lazy(() => SubjectUncheckedUpdateManyWithoutSchoolInputSchema) ]),
}).strict();

export const TeacherUpsertWithWhereUniqueWithoutSchoolInputSchema: z.ZodType<Prisma.TeacherUpsertWithWhereUniqueWithoutSchoolInput> = z.object({
  where: z.lazy(() => TeacherWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => TeacherUpdateWithoutSchoolInputSchema),z.lazy(() => TeacherUncheckedUpdateWithoutSchoolInputSchema) ]),
  create: z.union([ z.lazy(() => TeacherCreateWithoutSchoolInputSchema),z.lazy(() => TeacherUncheckedCreateWithoutSchoolInputSchema) ]),
}).strict();

export const TeacherUpdateWithWhereUniqueWithoutSchoolInputSchema: z.ZodType<Prisma.TeacherUpdateWithWhereUniqueWithoutSchoolInput> = z.object({
  where: z.lazy(() => TeacherWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => TeacherUpdateWithoutSchoolInputSchema),z.lazy(() => TeacherUncheckedUpdateWithoutSchoolInputSchema) ]),
}).strict();

export const TeacherUpdateManyWithWhereWithoutSchoolInputSchema: z.ZodType<Prisma.TeacherUpdateManyWithWhereWithoutSchoolInput> = z.object({
  where: z.lazy(() => TeacherScalarWhereInputSchema),
  data: z.union([ z.lazy(() => TeacherUpdateManyMutationInputSchema),z.lazy(() => TeacherUncheckedUpdateManyWithoutSchoolInputSchema) ]),
}).strict();

export const BuildingUpsertWithWhereUniqueWithoutSchoolInputSchema: z.ZodType<Prisma.BuildingUpsertWithWhereUniqueWithoutSchoolInput> = z.object({
  where: z.lazy(() => BuildingWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => BuildingUpdateWithoutSchoolInputSchema),z.lazy(() => BuildingUncheckedUpdateWithoutSchoolInputSchema) ]),
  create: z.union([ z.lazy(() => BuildingCreateWithoutSchoolInputSchema),z.lazy(() => BuildingUncheckedCreateWithoutSchoolInputSchema) ]),
}).strict();

export const BuildingUpdateWithWhereUniqueWithoutSchoolInputSchema: z.ZodType<Prisma.BuildingUpdateWithWhereUniqueWithoutSchoolInput> = z.object({
  where: z.lazy(() => BuildingWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => BuildingUpdateWithoutSchoolInputSchema),z.lazy(() => BuildingUncheckedUpdateWithoutSchoolInputSchema) ]),
}).strict();

export const BuildingUpdateManyWithWhereWithoutSchoolInputSchema: z.ZodType<Prisma.BuildingUpdateManyWithWhereWithoutSchoolInput> = z.object({
  where: z.lazy(() => BuildingScalarWhereInputSchema),
  data: z.union([ z.lazy(() => BuildingUpdateManyMutationInputSchema),z.lazy(() => BuildingUncheckedUpdateManyWithoutSchoolInputSchema) ]),
}).strict();
...
export const SchoolCreateOrConnectWithoutBuildingsInputSchema: z.ZodType<Prisma.SchoolCreateOrConnectWithoutBuildingsInput> = z.object({
  where: z.lazy(() => SchoolWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SchoolCreateWithoutBuildingsInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutBuildingsInputSchema) ]),
}).strict();
...
export const SchoolUpsertWithoutBuildingsInputSchema: z.ZodType<Prisma.SchoolUpsertWithoutBuildingsInput> = z.object({
  update: z.union([ z.lazy(() => SchoolUpdateWithoutBuildingsInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutBuildingsInputSchema) ]),
  create: z.union([ z.lazy(() => SchoolCreateWithoutBuildingsInputSchema),z.lazy(() => SchoolUncheckedCreateWithoutBuildingsInputSchema) ]),
  where: z.lazy(() => SchoolWhereInputSchema).optional()
}).strict();

export const SchoolUpdateToOneWithWhereWithoutBuildingsInputSchema: z.ZodType<Prisma.SchoolUpdateToOneWithWhereWithoutBuildingsInput> = z.object({
  where: z.lazy(() => SchoolWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => SchoolUpdateWithoutBuildingsInputSchema),z.lazy(() => SchoolUncheckedUpdateWithoutBuildingsInputSchema) ]),
}).strict();
...
export const FloorCreateWithoutRoomsInputSchema: z.ZodType<Prisma.FloorCreateWithoutRoomsInput> = z.object({
  id: z.string().optional(),
  number: z.number().int(),
  description: z.string().optional().nullable(),
  floorPlanUUID: z.string().optional().nullable(),
...
export const FloorUncheckedCreateWithoutRoomsInputSchema: z.ZodType<Prisma.FloorUncheckedCreateWithoutRoomsInput> = z.object({
  id: z.string().optional(),
  number: z.number().int(),
  description: z.string().optional().nullable(),
  floorPlanUUID: z.string().optional().nullable(),
...
export const FloorCreateOrConnectWithoutRoomsInputSchema: z.ZodType<Prisma.FloorCreateOrConnectWithoutRoomsInput> = z.object({
  where: z.lazy(() => FloorWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => FloorCreateWithoutRoomsInputSchema),z.lazy(() => FloorUncheckedCreateWithoutRoomsInputSchema) ]),
}).strict();

export const LessonCreateWithoutRoomInputSchema: z.ZodType<Prisma.LessonCreateWithoutRoomInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonUncheckedCreateWithoutRoomInputSchema: z.ZodType<Prisma.LessonUncheckedCreateWithoutRoomInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonCreateOrConnectWithoutRoomInputSchema: z.ZodType<Prisma.LessonCreateOrConnectWithoutRoomInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => LessonCreateWithoutRoomInputSchema),z.lazy(() => LessonUncheckedCreateWithoutRoomInputSchema) ]),
}).strict();

export const LessonCreateManyRoomInputEnvelopeSchema: z.ZodType<Prisma.LessonCreateManyRoomInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => LessonCreateManyRoomInputSchema),z.lazy(() => LessonCreateManyRoomInputSchema).array() ]),
}).strict();

export const FloorUpsertWithoutRoomsInputSchema: z.ZodType<Prisma.FloorUpsertWithoutRoomsInput> = z.object({
  update: z.union([ z.lazy(() => FloorUpdateWithoutRoomsInputSchema),z.lazy(() => FloorUncheckedUpdateWithoutRoomsInputSchema) ]),
  create: z.union([ z.lazy(() => FloorCreateWithoutRoomsInputSchema),z.lazy(() => FloorUncheckedCreateWithoutRoomsInputSchema) ]),
  where: z.lazy(() => FloorWhereInputSchema).optional()
}).strict();

export const FloorUpdateToOneWithWhereWithoutRoomsInputSchema: z.ZodType<Prisma.FloorUpdateToOneWithWhereWithoutRoomsInput> = z.object({
  where: z.lazy(() => FloorWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => FloorUpdateWithoutRoomsInputSchema),z.lazy(() => FloorUncheckedUpdateWithoutRoomsInputSchema) ]),
}).strict();
...
export const LessonUpsertWithWhereUniqueWithoutRoomInputSchema: z.ZodType<Prisma.LessonUpsertWithWhereUniqueWithoutRoomInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LessonUpdateWithoutRoomInputSchema),z.lazy(() => LessonUncheckedUpdateWithoutRoomInputSchema) ]),
  create: z.union([ z.lazy(() => LessonCreateWithoutRoomInputSchema),z.lazy(() => LessonUncheckedCreateWithoutRoomInputSchema) ]),
}).strict();

export const LessonUpdateWithWhereUniqueWithoutRoomInputSchema: z.ZodType<Prisma.LessonUpdateWithWhereUniqueWithoutRoomInput> = z.object({
  where: z.lazy(() => LessonWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LessonUpdateWithoutRoomInputSchema),z.lazy(() => LessonUncheckedUpdateWithoutRoomInputSchema) ]),
}).strict();

export const LessonUpdateManyWithWhereWithoutRoomInputSchema: z.ZodType<Prisma.LessonUpdateManyWithWhereWithoutRoomInput> = z.object({
  where: z.lazy(() => LessonScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LessonUpdateManyMutationInputSchema),z.lazy(() => LessonUncheckedUpdateManyWithoutRoomInputSchema) ]),
}).strict();

export const LessonCreateManyTeacherInputSchema: z.ZodType<Prisma.LessonCreateManyTeacherInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonUpdateWithoutTeacherInputSchema: z.ZodType<Prisma.LessonUpdateWithoutTeacherInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LessonUncheckedUpdateWithoutTeacherInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateWithoutTeacherInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LessonUncheckedUpdateManyWithoutTeacherInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateManyWithoutTeacherInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LessonCreateManySubjectInputSchema: z.ZodType<Prisma.LessonCreateManySubjectInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonUpdateWithoutSubjectInputSchema: z.ZodType<Prisma.LessonUpdateWithoutSubjectInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LessonUncheckedUpdateWithoutSubjectInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateWithoutSubjectInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LessonUncheckedUpdateManyWithoutSubjectInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateManyWithoutSubjectInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LessonCreateManyScheduleInputSchema: z.ZodType<Prisma.LessonCreateManyScheduleInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonUpdateWithoutScheduleInputSchema: z.ZodType<Prisma.LessonUpdateWithoutScheduleInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LessonUncheckedUpdateWithoutScheduleInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateWithoutScheduleInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LessonUncheckedUpdateManyWithoutScheduleInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateManyWithoutScheduleInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const StudentCreateManyClassInputSchema: z.ZodType<Prisma.StudentCreateManyClassInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const ScheduleCreateManyClassInputSchema: z.ZodType<Prisma.ScheduleCreateManyClassInput> = z.object({
  id: z.string().optional(),
  day: z.lazy(() => DaySchema),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const StudentUpdateWithoutClassInputSchema: z.ZodType<Prisma.StudentUpdateWithoutClassInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();

export const StudentUncheckedUpdateWithoutClassInputSchema: z.ZodType<Prisma.StudentUncheckedUpdateWithoutClassInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();

export const StudentUncheckedUpdateManyWithoutClassInputSchema: z.ZodType<Prisma.StudentUncheckedUpdateManyWithoutClassInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();

export const ScheduleUpdateWithoutClassInputSchema: z.ZodType<Prisma.ScheduleUpdateWithoutClassInput> = z.object({
  day: z.union([ z.lazy(() => DaySchema),z.lazy(() => EnumDayFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessons: z.lazy(() => LessonUpdateManyWithoutScheduleNestedInputSchema).optional()
...
export const ScheduleUncheckedUpdateWithoutClassInputSchema: z.ZodType<Prisma.ScheduleUncheckedUpdateWithoutClassInput> = z.object({
  day: z.union([ z.lazy(() => DaySchema),z.lazy(() => EnumDayFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessons: z.lazy(() => LessonUncheckedUpdateManyWithoutScheduleNestedInputSchema).optional()
...
export const ScheduleUncheckedUpdateManyWithoutClassInputSchema: z.ZodType<Prisma.ScheduleUncheckedUpdateManyWithoutClassInput> = z.object({
  day: z.union([ z.lazy(() => DaySchema),z.lazy(() => EnumDayFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();

export const SchoolClassCreateManySchoolInputSchema: z.ZodType<Prisma.SchoolClassCreateManySchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const SubjectCreateManySchoolInputSchema: z.ZodType<Prisma.SubjectCreateManySchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  teacherIds: z.union([ z.lazy(() => SubjectCreateteacherIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.coerce.date().optional(),
...
export const TeacherCreateManySchoolInputSchema: z.ZodType<Prisma.TeacherCreateManySchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  subjectIds: z.union([ z.lazy(() => TeacherCreatesubjectIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.coerce.date().optional(),
...
export const BuildingCreateManySchoolInputSchema: z.ZodType<Prisma.BuildingCreateManySchoolInput> = z.object({
  id: z.string().optional(),
  name: z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const SchoolClassUpdateWithoutSchoolInputSchema: z.ZodType<Prisma.SchoolClassUpdateWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  students: z.lazy(() => StudentUpdateManyWithoutClassNestedInputSchema).optional(),
...
export const SchoolClassUncheckedUpdateWithoutSchoolInputSchema: z.ZodType<Prisma.SchoolClassUncheckedUpdateWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  students: z.lazy(() => StudentUncheckedUpdateManyWithoutClassNestedInputSchema).optional(),
...
export const SchoolClassUncheckedUpdateManyWithoutSchoolInputSchema: z.ZodType<Prisma.SchoolClassUncheckedUpdateManyWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();

export const SubjectUpdateWithoutSchoolInputSchema: z.ZodType<Prisma.SubjectUpdateWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessons: z.lazy(() => LessonUpdateManyWithoutSubjectNestedInputSchema).optional(),
...
export const SubjectUncheckedUpdateWithoutSchoolInputSchema: z.ZodType<Prisma.SubjectUncheckedUpdateWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  teacherIds: z.union([ z.lazy(() => SubjectUpdateteacherIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SubjectUncheckedUpdateManyWithoutSchoolInputSchema: z.ZodType<Prisma.SubjectUncheckedUpdateManyWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  teacherIds: z.union([ z.lazy(() => SubjectUpdateteacherIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const TeacherUpdateWithoutSchoolInputSchema: z.ZodType<Prisma.TeacherUpdateWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessons: z.lazy(() => LessonUpdateManyWithoutTeacherNestedInputSchema).optional(),
...
export const TeacherUncheckedUpdateWithoutSchoolInputSchema: z.ZodType<Prisma.TeacherUncheckedUpdateWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  subjectIds: z.union([ z.lazy(() => TeacherUpdatesubjectIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const TeacherUncheckedUpdateManyWithoutSchoolInputSchema: z.ZodType<Prisma.TeacherUncheckedUpdateManyWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  subjectIds: z.union([ z.lazy(() => TeacherUpdatesubjectIdsInputSchema),z.string().array() ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const BuildingUpdateWithoutSchoolInputSchema: z.ZodType<Prisma.BuildingUpdateWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  floors: z.lazy(() => FloorUpdateManyWithoutBuildingNestedInputSchema).optional()
...
export const BuildingUncheckedUpdateWithoutSchoolInputSchema: z.ZodType<Prisma.BuildingUncheckedUpdateWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  floors: z.lazy(() => FloorUncheckedUpdateManyWithoutBuildingNestedInputSchema).optional()
...
export const BuildingUncheckedUpdateManyWithoutSchoolInputSchema: z.ZodType<Prisma.BuildingUncheckedUpdateManyWithoutSchoolInput> = z.object({
  name: z.union([ z.string().min(1, { message: "Името трябва да сърдържа поне 1 символ" }),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();
...
export const LessonCreateManyRoomInputSchema: z.ZodType<Prisma.LessonCreateManyRoomInput> = z.object({
  id: z.string().optional(),
  lessonNumber: z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),
  startTime: z.coerce.date(),
  endTime: z.coerce.date(),
...
export const LessonUpdateWithoutRoomInputSchema: z.ZodType<Prisma.LessonUpdateWithoutRoomInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LessonUncheckedUpdateWithoutRoomInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateWithoutRoomInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LessonUncheckedUpdateManyWithoutRoomInputSchema: z.ZodType<Prisma.LessonUncheckedUpdateManyWithoutRoomInput> = z.object({
  lessonNumber: z.union([ z.number().gte(0, { message: "Номерът на часа не може да бъде отрицателно число" }),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  startTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endTime: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lessonWeeks: z.union([ z.lazy(() => LessonWeekSchema),z.lazy(() => EnumLessonWeekFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SchoolClassFindFirstArgsSchema: z.ZodType<Prisma.SchoolClassFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ SchoolClassOrderByWithRelationInputSchema.array(),SchoolClassOrderByWithRelationInputSchema ]).optional(),
  cursor: SchoolClassWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ SchoolClassScalarFieldEnumSchema,SchoolClassScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export const SchoolClassFindFirstOrThrowArgsSchema: z.ZodType<Prisma.SchoolClassFindFirstOrThrowArgs> = z.object({
  select: SchoolClassSelectSchema.optional(),
  include: SchoolClassIncludeSchema.optional(),
  where: SchoolClassWhereInputSchema.optional(),
  orderBy: z.union([ SchoolClassOrderByWithRelationInputSchema.array(),SchoolClassOrderByWithRelationInputSchema ]).optional(),
...
export const SchoolClassFindManyArgsSchema: z.ZodType<Prisma.SchoolClassFindManyArgs> = z.object({
  select: SchoolClassSelectSchema.optional(),
  include: SchoolClassIncludeSchema.optional(),
  where: SchoolClassWhereInputSchema.optional(),
  orderBy: z.union([ SchoolClassOrderByWithRelationInputSchema.array(),SchoolClassOrderByWithRelationInputSchema ]).optional(),
...
export const SchoolClassAggregateArgsSchema: z.ZodType<Prisma.SchoolClassAggregateArgs> = z.object({
  where: SchoolClassWhereInputSchema.optional(),
  orderBy: z.union([ SchoolClassOrderByWithRelationInputSchema.array(),SchoolClassOrderByWithRelationInputSchema ]).optional(),
  cursor: SchoolClassWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
...
export const SchoolClassGroupByArgsSchema: z.ZodType<Prisma.SchoolClassGroupByArgs> = z.object({
  where: SchoolClassWhereInputSchema.optional(),
  orderBy: z.union([ SchoolClassOrderByWithAggregationInputSchema.array(),SchoolClassOrderByWithAggregationInputSchema ]).optional(),
...
export const SchoolClassFindUniqueArgsSchema: z.ZodType<Prisma.SchoolClassFindUniqueArgs> = z.object({
  select: SchoolClassSelectSchema.optional(),
  include: SchoolClassIncludeSchema.optional(),
  where: SchoolClassWhereUniqueInputSchema,
}).strict() ;

export const SchoolClassFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.SchoolClassFindUniqueOrThrowArgs> = z.object({
  select: SchoolClassSelectSchema.optional(),
  include: SchoolClassIncludeSchema.optional(),
  where: SchoolClassWhereUniqueInputSchema,
}).strict() ;
...
export const SchoolClassCreateArgsSchema: z.ZodType<Prisma.SchoolClassCreateArgs> = z.object({
  select: SchoolClassSelectSchema.optional(),
  include: SchoolClassIncludeSchema.optional(),
  data: z.union([ SchoolClassCreateInputSchema,SchoolClassUncheckedCreateInputSchema ]),
}).strict() ;

export const SchoolClassUpsertArgsSchema: z.ZodType<Prisma.SchoolClassUpsertArgs> = z.object({
  select: SchoolClassSelectSchema.optional(),
  include: SchoolClassIncludeSchema.optional(),
  where: SchoolClassWhereUniqueInputSchema,
  create: z.union([ SchoolClassCreateInputSchema,SchoolClassUncheckedCreateInputSchema ]),
  update: z.union([ SchoolClassUpdateInputSchema,SchoolClassUncheckedUpdateInputSchema ]),
}).strict() ;

export const SchoolClassCreateManyArgsSchema: z.ZodType<Prisma.SchoolClassCreateManyArgs> = z.object({
  data: z.union([ SchoolClassCreateManyInputSchema,SchoolClassCreateManyInputSchema.array() ]),
}).strict() ;

export const SchoolClassDeleteArgsSchema: z.ZodType<Prisma.SchoolClassDeleteArgs> = z.object({
  select: SchoolClassSelectSchema.optional(),
  include: SchoolClassIncludeSchema.optional(),
  where: SchoolClassWhereUniqueInputSchema,
}).strict() ;

export const SchoolClassUpdateArgsSchema: z.ZodType<Prisma.SchoolClassUpdateArgs> = z.object({
  select: SchoolClassSelectSchema.optional(),
  include: SchoolClassIncludeSchema.optional(),
  data: z.union([ SchoolClassUpdateInputSchema,SchoolClassUncheckedUpdateInputSchema ]),
  where: SchoolClassWhereUniqueInputSchema,
}).strict() ;

export const SchoolClassUpdateManyArgsSchema: z.ZodType<Prisma.SchoolClassUpdateManyArgs> = z.object({
  data: z.union([ SchoolClassUpdateManyMutationInputSchema,SchoolClassUncheckedUpdateManyInputSchema ]),
  where: SchoolClassWhereInputSchema.optional(),
}).strict() ;

export const SchoolClassDeleteManyArgsSchema: z.ZodType<Prisma.SchoolClassDeleteManyArgs> = z.object({
  where: SchoolClassWhereInputSchema.optional(),
}).strict() ;
